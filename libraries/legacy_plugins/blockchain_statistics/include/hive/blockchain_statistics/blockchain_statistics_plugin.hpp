...
public:
  ...
  share_type           hbd_paid_to_authors = 0;                     ///< Amount of HBD paid to authors
  ...
  share_type           liquidity_rewards_paid = 0;                  ///< Amount of HIVE paid to market makers
  uint32_t             transfers_to_vesting = 0;                    ///< Transfers of HIVE into VESTS
  share_type           hive_vested = 0;                             ///< Amount of HIVE vested
  ...
  share_type           vests_withdrawn = 0;                         ///< Amount of VESTS withdrawn to HIVE
