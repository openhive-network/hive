...
#include <hive/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
  public:
    blockchain_statistics_api( const hive::app::api_context& ctx );
...
FC_REFLECT( hive::blockchain_statistics::statistics,
  (blocks)
  (bandwidth)
  (operations)
  (transactions)
...
FC_API( hive::blockchain_statistics::blockchain_statistics_api,
  (get_stats_for_time)
