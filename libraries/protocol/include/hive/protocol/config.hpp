...
#define HIVE_MINING_REWARD                    hive::protocol::HIVE_asset( 1000 )
...
#define HIVE_MIN_LIQUIDITY_REWARD             hive::protocol::HIVE_asset( 1000*HIVE_LIQUIDITY_REWARD_BLOCKS ) // Minumum reward to be paid out to liquidity providers
...
#define HIVE_ACTIVE_CHALLENGE_FEE             hive::protocol::HIVE_asset( 2000 )
#define HIVE_OWNER_CHALLENGE_FEE              hive::protocol::HIVE_asset( 30000 )
...
#define HIVE_MIN_PAYOUT_HBD                   hive::protocol::HBD_asset( 20 )
