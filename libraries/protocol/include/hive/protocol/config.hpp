...
#define HIVE_START_MINER_VOTING_BLOCK         10
...
#ifdef REDUCED_VOTING_INTERVAL

#define HIVE_DELAYED_VOTING_TOTAL_INTERVAL_SECONDS (60*10) // 10 minutes
#define HIVE_DELAYED_VOTING_INTERVAL_SECONDS       (60)  // 1 minute
