...
using fc::ecc::canonical_signature_type;
  ...
  struct transaction
  {
    ...
    digest_type         sig_digest( const chain_id_type& chain_id, bool swap_pack_mode )const;
  ...
  struct signed_transaction : public transaction
  {
    ...
    flat_set<public_key_type> get_signature_keys( const chain_id_type& chain_id, canonical_signature_type/* = fc::ecc::fc_canonical*/, bool swap_pack_mode )const;
