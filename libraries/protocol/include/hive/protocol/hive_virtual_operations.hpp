...
struct interest_operation : public virtual_operation
{
  ...
  interest_operation( const account_name_type& o, const asset& i )
    : owner( o ), interest( i )
  {}
...
struct sps_fund_operation : public virtual_operation
{
  ...
  sps_fund_operation( const account_name_type& _fund, const asset& v )
...
struct sps_convert_operation : public virtual_operation
{
  ...
  sps_convert_operation( const account_name_type& f, const asset& c, const asset& a )
...
struct account_created_operation : public virtual_operation
{
  ...
  account_created_operation( const account_name_type& new_account_name, const account_name_type& creator, const asset& initial_vesting_shares, const asset& initial_delegation )
