...
fc::variant_object get_config( const std::string& treasury_name, const fc::sha256& chain_id )
{
  ...
  result["HIVE_ACTIVE_CHALLENGE_FEE"] = HIVE_ACTIVE_CHALLENGE_FEE.to_asset();
  ...
  result["HIVE_MIN_CONTENT_REWARD"] = HIVE_MIN_CONTENT_REWARD.to_asset();
  result["HIVE_MIN_CURATE_REWARD"] = HIVE_MIN_CURATE_REWARD.to_asset();
  ...
  result["HIVE_MINING_REWARD"] = HIVE_MINING_REWARD.to_asset();
  result["HIVE_MINING_TIME"] = HIVE_MINING_TIME;
  result["HIVE_MIN_LIQUIDITY_REWARD"] = HIVE_MIN_LIQUIDITY_REWARD.to_asset();
  result["HIVE_MIN_LIQUIDITY_REWARD_PERIOD_SEC"] = HIVE_MIN_LIQUIDITY_REWARD_PERIOD_SEC;
  result["HIVE_MIN_PAYOUT_HBD"] = HIVE_MIN_PAYOUT_HBD.to_asset();
  result["HIVE_MIN_POW_REWARD"] = HIVE_MIN_POW_REWARD.to_asset();
  result["HIVE_MIN_PRODUCER_REWARD"] = HIVE_MIN_PRODUCER_REWARD.to_asset();
  ...
  result["HIVE_OWNER_CHALLENGE_FEE"] = HIVE_OWNER_CHALLENGE_FEE.to_asset();
