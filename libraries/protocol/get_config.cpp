...
fc::variant_object get_config( const config_blockchain_type& config, const std::string& treasury_name )
{
  ...
  result["HIVE_ACCOUNT_RECOVERY_REQUEST_EXPIRATION_PERIOD"] = config.HIVE_ACCOUNT_RECOVERY_REQUEST_EXPIRATION_PERIOD;
  ...
  result["HIVE_CASHOUT_WINDOW_SECONDS"] = config.HIVE_CASHOUT_WINDOW_SECONDS;
  result["HIVE_CASHOUT_WINDOW_SECONDS_PRE_HF12"] = config.HIVE_CASHOUT_WINDOW_SECONDS_PRE_HF12;
  result["HIVE_CASHOUT_WINDOW_SECONDS_PRE_HF17"] = config.HIVE_CASHOUT_WINDOW_SECONDS_PRE_HF17;
  result["HIVE_CHAIN_ID"] = config.HIVE_CHAIN_ID;
...
#endif
  result["HIVE_INIT_SUPPLY"] = config.HIVE_INIT_SUPPLY;
  result["HIVE_HBD_INIT_SUPPLY"] = config.HIVE_HBD_INIT_SUPPLY;
  ...
  result["HIVE_MAX_CASHOUT_WINDOW_SECONDS"] = config.HIVE_MAX_CASHOUT_WINDOW_SECONDS;
  ...
  result["HIVE_OWNER_AUTH_HISTORY_TRACKING_START_BLOCK_NUM"] = config.HIVE_OWNER_AUTH_HISTORY_TRACKING_START_BLOCK_NUM;
  result["HIVE_OWNER_AUTH_RECOVERY_PERIOD"] = config.HIVE_OWNER_AUTH_RECOVERY_PERIOD;
  ...
  result["HIVE_OWNER_UPDATE_LIMIT"] = config.HIVE_OWNER_UPDATE_LIMIT;
  ...
  result["HIVE_SECOND_CASHOUT_WINDOW"] = config.HIVE_SECOND_CASHOUT_WINDOW;
  ...
  result["HIVE_UPVOTE_LOCKOUT_HF17"] = config.HIVE_UPVOTE_LOCKOUT_HF17;
  result["HIVE_UPVOTE_LOCKOUT_SECONDS"] = config.HIVE_UPVOTE_LOCKOUT_SECONDS;
  ...
  result["HIVE_DELEGATION_RETURN_PERIOD_HF0"] = config.HIVE_DELEGATION_RETURN_PERIOD_HF0;
