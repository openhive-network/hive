...
HIVE_OBJECT_ID_TYPE( rc_resource_param );
...
HIVE_OBJECT_ID_TYPE( rc_account );
...
HIVE_OBJECT_ID_TYPE( rc_delegation_pool );
...
HIVE_OBJECT_ID_TYPE( rc_delegation_from_account );
...
HIVE_OBJECT_ID_TYPE( rc_indel_edge );
...
HIVE_OBJECT_ID_TYPE( rc_outdel_drc_edge );
