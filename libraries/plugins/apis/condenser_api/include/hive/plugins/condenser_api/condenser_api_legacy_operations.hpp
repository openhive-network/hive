...
namespace hive { namespace plugins { namespace condenser_api {
  ...
  typedef declined_voting_rights_operation       legacy_declined_voting_rights_operation;
  ...
  typedef fc::static_variant<
        ...
        legacy_declined_voting_rights_operation
      > legacy_operation;
  ...
  struct legacy_operation_conversion_visitor
  {
    ...
    bool operator()( const legacy_declined_voting_rights_operation& op )const  { l_op = op; return true; }
