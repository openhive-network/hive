...
#define HIVE_NETWORK_NODE_API_PLUGIN_NAME "network_node_api"

namespace hive { namespace plugins { namespace network_node_api {

using namespace appbase;

class network_node_api_plugin : public appbase::plugin< network_node_api_plugin >
{
public:
   ...
   std::shared_ptr< class network_node_api > api;
};
