...
class wallet_formatter
{
  private:
    ...
    using function_type = function<string( variant, const fc::variants& )>;

    static string help( variant result, const fc::variants& a )
    {
      return result.get_string();
    }

    static string get_help( variant result, const fc::variants& a )
    {
      return result.get_string();
    }

    static string list_my_accounts( variant result, const fc::variants& a )
    {
    ...
    static string get_account_history( variant result, const fc::variants& a )
    {
      std::stringstream ss;
      ss << std::left << setw( 8 )  << "#" << " ";
    ...
    static string get_open_orders( variant result, const fc::variants& a )
    {
    ...
    static string get_order_book( variant result, const fc::variants& a )
    {
    ...
    static string get_withdraw_routes ( variant result, const fc::variants& a )
    {
