...
variant wallet_formatter::help( format_type format )
{
  std::vector<std::string> method_names = method_documentation.get_method_names();
  std::stringstream ss;
  for( const std::string& method_name : method_names )
  {
    try
    {
      ss << method_documentation.get_brief_description(method_name);
    }
...
variant wallet_formatter::gethelp( const string& method, format_type format )
{
  std::stringstream ss;
  ss << "\n";

  std::string doxygenHelpString = method_documentation.get_detailed_description(method);
...
string wallet_formatter::get_account_history( variant result )
{
  std::stringstream ss;
  ss << std::left << setw( 8 )  << "#" << " ";
...
string wallet_formatter::get_open_orders( variant result )
{
...
string wallet_formatter::get_order_book( variant result )
{
...
string wallet_formatter::get_withdraw_routes( variant result )
{
