...
template <>
void PSQL::sql_serializer_visitor::process(const transfer_to_vesting_operation &op, sql_command_t &ret) const
{
  get_asset_details(op.amount, ret);
}

template <>
void PSQL::sql_serializer_visitor::process(const transfer_operation &op, sql_command_t &ret) const
{
  get_asset_details(op.amount, ret);
}

template <>
void PSQL::sql_serializer_visitor::process(const account_witness_vote_operation &op, sql_command_t &ret) const
{
  get_id_details(op.approve, ret);
}

template <>
void PSQL::sql_serializer_visitor::process(const comment_operation &op, sql_command_t &ret) const
{
  get_permlink_details(op.permlink, ret);
}

template <>
void PSQL::sql_serializer_visitor::process(const vote_operation &op, sql_command_t &ret) const
{
  get_permlink_details(op.permlink, ret);
}

template <>
void PSQL::sql_serializer_visitor::process(const withdraw_vesting_operation &op, sql_command_t &ret) const
{
  get_asset_details(op.vesting_shares, ret);
}

template <>
void PSQL::sql_serializer_visitor::process(const custom_operation &op, sql_command_t &ret) const
{
  get_id_details(op.id, ret);
}

template <>
void PSQL::sql_serializer_visitor::process(const limit_order_create_operation &op, sql_command_t &ret) const
{
  get_id_details(op.orderid, ret);
}

template <>
void PSQL::sql_serializer_visitor::process(const limit_order_cancel_operation &op, sql_command_t &ret) const
{
  get_id_details(op.orderid, ret);
}

template <>
void PSQL::sql_serializer_visitor::process(const delete_comment_operation &op, sql_command_t &ret) const
{
  get_permlink_details(op.permlink, ret);
}

template <>
void PSQL::sql_serializer_visitor::process(const set_withdraw_vesting_route_operation &op, sql_command_t &ret) const
{
  get_id_details(op.percent, ret);
}

template <>
void PSQL::sql_serializer_visitor::process(const convert_operation &op, sql_command_t &ret) const
{
