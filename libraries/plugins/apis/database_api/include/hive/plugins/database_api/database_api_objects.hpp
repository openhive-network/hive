...
struct api_account_object
{
  api_account_object( const account_object& a, const database& db, bool delayed_votes_active ) :
    ...
    last_account_recovery( a.recovery.get_block_last_account_recovery_time() ),
    post_count( a.post_count ),
    can_vote( a.can_vote ),
    voting_manabar( a.voting_manabar ),
    downvote_manabar( a.downvote_manabar ),
    balance( a.assets.get_balance() ),
    savings_balance( a.assets.get_savings() ),
    hbd_balance( a.assets.get_hbd_balance() ),
    ...
    savings_hbd_balance( a.assets.get_hbd_savings() ),
    ...
    reward_hbd_balance( a.assets.get_hbd_rewards() ),
    reward_hive_balance( a.assets.get_rewards() ),
    reward_vesting_balance( a.assets.get_vest_rewards() ),
    reward_vesting_hive( a.assets.get_vest_rewards_as_hive() ),
    curation_rewards( a.assets.get_curation_rewards().amount ),
    posting_rewards( a.assets.get_posting_rewards().amount ),
    vesting_shares( a.assets.get_vesting() ),
    delegated_vesting_shares( a.assets.get_delegated_vesting() ),
    received_vesting_shares( a.assets.get_received_vesting() ),
    vesting_withdraw_rate( a.assets.get_vesting_withdraw_rate() ),
    next_vesting_withdrawal( a.next_vesting_withdrawal ),
    withdrawn( a.assets.get_withdrawn().amount ),
    to_withdraw( a.assets.get_to_withdraw().amount ),
    ...
    governance_vote_expiration_ts( a.get_governance_vote_expiration_ts())
  {
    ...
    if( a.recovery.has_recovery_account() )
      recovery_account = db.get_account( a.recovery.get_recovery_account() ).get_name();
