...
network_broadcast_api_plugin::network_broadcast_api_plugin( appbase::application& app ): appbase::plugin<network_broadcast_api_plugin>( app ) {}
...
{
  api = std::make_shared< network_broadcast_api >( theApp );
}
