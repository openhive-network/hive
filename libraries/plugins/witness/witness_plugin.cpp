...
namespace detail {
  ...
  public:
    ...
    bool                                                               _debug_production_switch = true;
  };
  ...
  //         ilog("Not producing block because slot has not yet arrived");
      ...
      case block_production_condition::debug_stop:
        elog( "Not producing block because production was stopped by debug_node plugin" );
        break;
    }
...
#ifndef IS_TEST_NET
    if( _debug_production_switch == false )
  ...
  bool witness_plugin_impl::set_debug_switch_production(bool next)
  {
    bool previous = _debug_production_switch;
    _debug_production_switch = next;
    return previous;
  }
} // detail
...
bool witness_plugin::set_debug_switch_production(bool next)
{
  return my->set_debug_switch_production(next);
}
