...
{
  std::string mm_ticks_json = hive::jsonball::get_market_maker_ticks();
  fc::variant mm_ticks_var = fc::json::from_string( mm_ticks_json, fc::json::format_validation_mode::full, fc::json::strict_parser );
