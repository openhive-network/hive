...
void pre_hf20_vote_evaluator( const vote_operation& o, database& _db )
{
  ...
  int64_t abs_rshares = fc::uint128_to_int64( ( uint128_t( voter.get_effective_vesting_shares( voter_assets_for_voting, voter_time, false ).value ) * used_power ) / HIVE_100_PERCENT );
