...
namespace steem { namespace chain {
   ...
   class database : public chainbase::database
   {
      ...
      public:
         ...
         share_type pay_curators( const comment_object& c, TTempBalance* reward_balance, share_type& max_rewards );
         share_type cashout_comment_helper( util::comment_reward_context& ctx, const comment_object& comment,
            TTempBalance* reward_balance, bool forward_curation_remainder = true );
   ...
   protected:
      ...
      private:
         ...
         void adjust_smt_balance( const account_name_type& name, const asset& delta, modifier_type&& modifier );
#endif
