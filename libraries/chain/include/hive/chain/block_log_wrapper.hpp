...
namespace hive { namespace chain {
  ...
  public:
    ...
    virtual void open_and_init( const block_log_open_args& bl_open_args, bool read_only,
                                bool allow_artifacts_regeneration, database* db ) override;
  ...
  private:
    ...
    void open_and_init( const fc::path& path, bool read_only, bool allow_artifacts_regeneration,
                        uint32_t start_from_part = 1 );
    // Common helpers
    void common_open_and_init( bool read_only, bool allow_artifacts_regeneration,
