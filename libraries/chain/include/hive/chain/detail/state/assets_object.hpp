...
namespace hive { namespace chain {
  ...
  class assets_object : public object< assets_object_type, assets_object >
  {
    ...
    public:
      ...
      // ===== Balance accessors (formerly assets_object only) =====
      ...
      // ===== Time/schedule accessors (formerly in time_object) =====
  ...
  typedef multi_index_container<
    ...
    indexed_by<
      ...
      ordered_unique< tag< by_next_vesting_withdrawal >,
        composite_key< assets_object,
          const_mem_fun< assets_object, time_point_sec, &assets_object::get_next_vesting_withdrawal >,
          const_mem_fun< assets_object, const account_name_type&, &assets_object::get_name >
        >
      >
    >,
