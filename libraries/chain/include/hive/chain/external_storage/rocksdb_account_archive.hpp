...
class rocksdb_account_archive : public accounts_handler
{
  protected:
    ...
    rocksdb_account_column_family_iterator_provider::ptr get_rocksdb_account_column_family_iterator_provider() const override;
...
#else
    const size_t volatile_objects_limit = 100'000;
#endif
