...
class accounts_handler : public external_storage_snapshot
{
  public:
    ...
    virtual void create_volatile_account_metadata( uint32_t block_num, const account_metadata_object& obj ) = 0;
    virtual account_metadata get_account_metadata( const std::string& account_name ) const = 0;

    virtual void create_volatile_account_authority( uint32_t block_num, const account_authority_object& obj ) = 0;
