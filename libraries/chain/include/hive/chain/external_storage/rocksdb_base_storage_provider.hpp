...
class rocksdb_base_storage_provider: public rocksdb_storage_provider
{
  private:
  ...
  public:
    ...
    rocksdb_base_storage_provider( const bfs::path& blockchain_storage_path, const bfs::path& storage_path, appbase::application& app, const std::string& name );
