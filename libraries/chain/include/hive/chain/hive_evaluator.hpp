...
HIVE_DEFINE_EVALUATOR( smt_set_token_metadata )
HIVE_DEFINE_EVALUATOR( smt_approve )
HIVE_DEFINE_EVALUATOR( smt_transfer_from )
HIVE_DEFINE_EVALUATOR( smt_transfer_control )
#endif
