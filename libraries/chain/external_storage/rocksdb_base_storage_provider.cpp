...
rocksdb_base_storage_provider::rocksdb_base_storage_provider( const bfs::path& blockchain_storage_path, const bfs::path& storage_path, appbase::application& app, const std::string& name )
  : rocksdb_storage_provider( blockchain_storage_path, storage_path, app, name )
{
