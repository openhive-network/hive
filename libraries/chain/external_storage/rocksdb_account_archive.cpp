...
{
  static void write_to_storage( const external_storage_provider::ptr& provider, const account_name_slice_t& key, const account_object& object, ColumnTypes column_type )
  {
...
{
  static bool read_from_storage( const external_storage_provider::ptr& provider, const account_name_slice_t& key, ColumnTypes column_type, PinnableWideColumns& wide_columns )
  {
