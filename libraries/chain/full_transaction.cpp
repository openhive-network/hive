...
void full_transaction_type::sign_transaction(const std::vector<hive::protocol::private_key_type>& keys, const hive::protocol::chain_id_type& chain_id,
  fc::ecc::canonical_signature_type canon_type, hive::protocol::pack_type serialization_type, bool cache)
{
  ...
  {
    auto signature = key.sign_compact(new_signature_info.sig_digest, canon_type);
