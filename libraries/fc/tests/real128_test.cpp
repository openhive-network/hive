...
BOOST_AUTO_TEST_CASE(real128_test)
{
   ...
   BOOST_CHECK_EQUAL(real128(8).to_uint64(), static_cast< size_t >( 8 ) );
   BOOST_CHECK_EQUAL(real128(6789).to_uint64(), static_cast< size_t >( 6789 ) );
   BOOST_CHECK_EQUAL(real128(10000).to_uint64(), static_cast< size_t >( 10000 ) );
   ...
   BOOST_CHECK_EQUAL(real128("12345.6789").to_uint64(), static_cast< size_t >( 12345 ) );
   BOOST_CHECK_EQUAL((real128("12345.6789")*10000).to_uint64(), static_cast< size_t >( 123456789 ) );
