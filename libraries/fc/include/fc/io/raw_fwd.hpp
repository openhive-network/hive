...
namespace fc {
   ...
   namespace raw {
    ...
    template<typename Stream, typename Storage> inline void pack( Stream& s, const fc::fixed_string<Storage>& u, const pack_flags& flags );
    ...
    template<typename Stream, typename... T> inline void pack( Stream& s, const std::set<T...>& value, const pack_flags& flags );
    template<typename Stream, typename... T> inline void unpack( Stream& s, std::set<T...>& value, uint32_t depth = 0 );
    template<typename Stream, typename... T> inline void pack( Stream& s, const std::multiset<T...>& value, const pack_flags& flags );
    template<typename Stream, typename... T> inline void unpack( Stream& s, std::multiset<T...>& value, uint32_t depth = 0 );
    template<typename Stream, typename T> inline void pack( Stream& s, const std::unordered_set<T>& value, const pack_flags& flags );
    template<typename Stream, typename T> inline void unpack( Stream& s, std::unordered_set<T>& value, uint32_t depth = 0 );

    template<typename Stream, typename... T> void pack( Stream& s, const static_variant<T...>& sv, const pack_flags& flags );
    template<typename Stream, typename... T> void unpack( Stream& s, static_variant<T...>& sv, uint32_t depth = 0 );

    template<typename Stream, typename K, typename V> inline void pack( Stream& s, const std::unordered_map<K,V>& value, const pack_flags& flags );
    template<typename Stream, typename K, typename V> inline void unpack( Stream& s, std::unordered_map<K,V>& value, uint32_t depth = 0 );

    template<typename Stream, typename K, typename V> inline void pack( Stream& s, const std::map<K,V>& value, const pack_flags& flags );
    template<typename Stream, typename K, typename V> inline void unpack( Stream& s, std::map<K,V>& value, uint32_t depth = 0 );

    template<typename Stream, typename K, typename V> inline void pack( Stream& s, const std::pair<K,V>& value, const pack_flags& flags );
    template<typename Stream, typename K, typename V> inline void unpack( Stream& s, std::pair<K,V>& value, uint32_t depth = 0 );

    template<typename Stream> inline void pack( Stream& s, const variant_object& v, const pack_flags& flags );
    template<typename Stream> inline void unpack( Stream& s, variant_object& v, uint32_t depth = 0 );
    template<typename Stream> inline void pack( Stream& s, const variant& v, const pack_flags& flags );
    template<typename Stream> inline void unpack( Stream& s, variant& v, uint32_t depth = 0 );

    template<typename Stream> inline void pack( Stream& s, const path& v, const pack_flags& flags );
    template<typename Stream> inline void unpack( Stream& s, path& v, uint32_t depth = 0 );
    template<typename Stream> inline void pack( Stream& s, const ip::endpoint& v, const pack_flags& flags );
    template<typename Stream> inline void unpack( Stream& s, ip::endpoint& v, uint32_t depth = 0 );
    template<typename Stream> inline void pack( Stream& s, const ip::address& v, const pack_flags& flags );
    ...
    template<typename Stream, typename T> void pack( Stream& s, const fc::optional<T>& v, const pack_flags& flags );
    template<typename Stream, typename T> void pack( Stream& s, const safe<T>& v, const pack_flags& flags );
    ...
    template<typename Stream> void pack( Stream& s, const microseconds&, const pack_flags& flags );
    template<typename Stream> void unpack( Stream& s, time_point&, uint32_t depth = 0 );
    template<typename Stream> void pack( Stream& s, const time_point&, const pack_flags& flags );
    template<typename Stream> void unpack( Stream& s, time_point_sec&, uint32_t depth = 0 );
    template<typename Stream> void pack( Stream& s, const time_point_sec&, const pack_flags& flags );
    template<typename Stream> void unpack( Stream& s, std::string&, uint32_t depth = 0 );
    template<typename Stream> void pack( Stream& s, const std::string&, const pack_flags& flags );
    template<typename Stream> void unpack( Stream& s, fc::ecc::public_key&, uint32_t depth = 0 );
    template<typename Stream> void pack( Stream& s, const fc::ecc::public_key&, const pack_flags& flags );
    template<typename Stream> void unpack( Stream& s, fc::ecc::private_key&, uint32_t depth = 0 );
    template<typename Stream> void pack( Stream& s, const fc::ecc::private_key&, const pack_flags& flags );

    template<typename Stream, typename T> inline void pack( Stream& s, const T& v, const pack_flags& flags );
    template<typename Stream, typename T> inline void unpack( Stream& s, T& v, uint32_t depth = 0 );

    template<typename Stream, typename T> inline void pack( Stream& s, const std::vector<T>& v, const pack_flags& flags );
    ...
    template<typename Stream> inline void pack( Stream& s, const char* v, const pack_flags& flags );
    ...
    template<typename Stream, typename T, size_t N> inline void pack( Stream& s, const fc::array<T,N>& v, const pack_flags& flags);
    template<typename Stream, typename T, size_t N> inline void unpack( Stream& s, fc::array<T,N>& v, uint32_t depth = 0);

    template<typename Stream, typename T, size_t N> inline void pack( Stream& s, const fc::int_array<T,N>& v, const pack_flags& flags);
    template<typename Stream, typename T, size_t N> inline void unpack( Stream& s, fc::int_array<T,N>& v, uint32_t depth = 0);

    template<typename Stream> inline void pack( Stream& s, const bool& v, const pack_flags& flags );
    ...
    template<typename T> inline std::vector<char> pack_to_vector( const T& v, const pack_flags& flags );
