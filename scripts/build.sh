...
message(STATUS "CTestTestfile.cmake: Processing...")
message(STATUS "CMAKE_CURRENT_LIST_DIR = ${CMAKE_CURRENT_LIST_DIR}")

# Discover chain_test tests
if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/chain_test")
  message(STATUS "chain_test executable found")
  set(__tests_file "${CMAKE_CURRENT_LIST_DIR}/chain_test[1]_tests.cmake")
  if(NOT EXISTS "${__tests_file}" OR "${CMAKE_CURRENT_LIST_DIR}/chain_test" IS_NEWER_THAN "${__tests_file}")
    message(STATUS "Running test discovery for chain_test...")
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/BoostTestAddTests.cmake")
      ...
      boosttest_discover_tests_impl(
        ...
        CTEST_FILE "${__tests_file}"
        TEST_DISCOVERY_TIMEOUT "60"
      )
      message(STATUS "Test discovery complete, including ${__tests_file}")
    else()
      message(WARNING "BoostTestAddTests.cmake not found!")
    endif()
  else()
    message(STATUS "Using cached test list from ${__tests_file}")
  endif()
  if(EXISTS "${__tests_file}")
    include("${__tests_file}")
  else()
    message(WARNING "Tests file ${__tests_file} does not exist after discovery!")
  endif()
else()
  message(STATUS "chain_test executable NOT found at ${CMAKE_CURRENT_LIST_DIR}/chain_test")
endif()

# Discover plugin_test tests
if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/plugin_test")
  message(STATUS "plugin_test executable found")
  set(__tests_file "${CMAKE_CURRENT_LIST_DIR}/plugin_test[1]_tests.cmake")
  if(NOT EXISTS "${__tests_file}" OR "${CMAKE_CURRENT_LIST_DIR}/plugin_test" IS_NEWER_THAN "${__tests_file}")
    message(STATUS "Running test discovery for plugin_test...")
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/BoostTestAddTests.cmake")
      include("${CMAKE_CURRENT_LIST_DIR}/BoostTestAddTests.cmake")
      boosttest_discover_tests_impl(
      ...
      message(STATUS "Test discovery complete for plugin_test")
    else()
      message(WARNING "BoostTestAddTests.cmake not found!")
    endif()
  endif()
...
message(STATUS "CTestTestfile.cmake: Done")
EOF
