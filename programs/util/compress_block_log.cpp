...
{
  auto log_writer = hive::chain::block_log_wrapper::create_opened_wrapper( output_path, app, thread_pool, false /*read_only*/, false /*allow_artifacts_regeneration*/ );
...
void fill_pending_queue(const fc::path &input_path, const bool read_only, uint32_t &current_block_number, appbase::application& app, hive::chain::blockchain_worker_thread_pool& thread_pool)
{
  ...
  auto log_reader = hive::chain::block_log_wrapper::create_opened_wrapper( input_path, app, thread_pool, read_only, false /*allow_artifacts_regeneration*/ );
