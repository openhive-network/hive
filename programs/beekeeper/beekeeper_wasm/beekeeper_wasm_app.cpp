...
{
  return std::make_shared<beekeeper::beekeeper_wallet_manager>( std::make_shared<session_manager_base>( std::make_shared<time_manager_base>() ), std::make_shared<beekeeper_instance_base>(),
