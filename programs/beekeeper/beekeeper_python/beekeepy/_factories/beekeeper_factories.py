...
def beekeeper_factory(*, settings: Settings | None = None) -> SynchronousBeekeeperInterface:
    ...
    """
    return _beekeeper_factory_impl(SynchronousBeekeeper, SynchronousBeekeeperHandle, beekeeper_remote_factory, settings)  # type: ignore[return-value]
...
def beekeeper_remote_factory(*, url_or_settings: HttpUrl | Settings) -> SynchronousBeekeeperInterface:
    ...
    return _beekeeper_remote_factory_impl(SynchronousBeekeeper, SynchronousRemoteBeekeeperHandle, url_or_settings)  # type: ignore[return-value]
...
def async_beekeeper_factory(*, settings: Settings | None = None) -> AsynchronousBeekeeperInterface:
    ...
    return _beekeeper_factory_impl(AsynchronousBeekeeper, AsynchronousBeekeeperHandle, async_beekeeper_remote_factory, settings)  # type: ignore[return-value]
...
def async_beekeeper_remote_factory(*, url_or_settings: HttpUrl | Settings) -> AsynchronousBeekeeperInterface:
    ...
    return _beekeeper_remote_factory_impl(AsynchronousBeekeeper, AsynchronousRemoteBeekeeperHandle, url_or_settings)  # type: ignore[return-value]
