...
std::string beekeeper_wallet_manager::encrypt_data( const std::string& token, const std::string& from_public_key, const std::string& to_public_key, const std::string& wallet_name, const std::string& content, const std::string& seed )
{
  sessions->check_timeout( token );
  return sessions->get_wallet_manager( token )->encrypt_data( create_public_key( from_public_key ), create_public_key( to_public_key ), wallet_name, content, seed );
}
