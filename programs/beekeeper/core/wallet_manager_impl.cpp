...
std::string wallet_manager_impl::encrypt_data( const public_key_type& from_public_key, const public_key_type& to_public_key, const std::string& wallet_name, const std::string& content, const std::string& seed )
{
  fc::crypto_data _cd;
  ...
  return _cd.encrypt( _private_key.value(), to_public_key, content, seed );
}
