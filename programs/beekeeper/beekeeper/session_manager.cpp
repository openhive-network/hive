...
std::shared_ptr<session_base> session_manager::create_session( const std::string& notifications_endpoint, const std::string& token, std::shared_ptr<time_manager_base> _not_used_time )
{
