...
namespace hive { namespace converter { namespace plugins {
  ...
  public:
    ...
    conversion_plugin_impl( const private_key_type& _private_key, const chain_id_type& chain_id, size_t signers_size, const fc::raw::pack_flags& flags, bool increase_block_size = true )
      : converter( _private_key, chain_id, flags, signers_size, increase_block_size ) {}
