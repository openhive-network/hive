...
namespace hive { namespace converter { namespace plugins {
  ...
  public:
    ...
    conversion_plugin_impl( const private_key_type& _private_key, const chain_id_type& chain_id, size_t signers_size, appbase::application& app, bool increase_block_size = true )
