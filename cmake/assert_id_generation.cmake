macro(assert_id_generation
  ...
  list(APPEND assert_expressions "#include <fc/exception/exception.hpp>\n")
  list(APPEND assert_expressions "#include <fstream>\n\n")
  list(APPEND assert_expressions "#define HASH_EXPR( EXPR ) fc::exception::hash_expr( #EXPR )\n\n")
  list(APPEND assert_expressions "int main( int argc, char** argv ){\n")
  list(APPEND assert_expressions "  uint64_t h = 0\;\n")
  list(APPEND assert_expressions "  std::fstream fsv, fsw\;\n")
  list(APPEND assert_expressions "  fsv.open(\"${assertion_id_verifier_header_path}\", std::ios::out | std::ios::trunc)\;\n")
  list(APPEND assert_expressions "  fsv << \"#include <cstdint>\" << std::endl\;\n")
  list(APPEND assert_expressions "  fsw.open(\"${assertion_id_wax_inline_path}\", std::ios::out | std::ios::trunc)\;\n")
  ...
  foreach(file ${sources})
    ...
    if(NOT "${file_contents}" STREQUAL "")
      ...
      foreach(line ${file_contents})
        ...
        list(APPEND assert_expressions "  h = HASH_EXPR( ${trimmed_expr} )\;\n")
        list(APPEND assert_expressions "  fsv << \"uint64_t assertion_\" << h << \" = \" << h << \"ull\; /*${file}*/ /*${trimmed_for_string}*/ \" << std::endl\;\n")
        list(APPEND assert_expressions "  fsw << \"container.insert( std::make_pair( \" << h << \"ull, \\\"${assertion_id_namespace}\\\") )\;\" << std::endl\;\n")
      endforeach()
    #message(">> ${file_contents} <<")
    endif()
  endforeach()

  list(APPEND assert_expressions "  fsv.close()\;\n")
  list(APPEND assert_expressions "  fsw.close()\;\n")
  list(APPEND assert_expressions "  return 0\;\n")
...
list(APPEND assert_id_verifier "#include \"${assertion_id_verifier_header_path}\"\n")
list(APPEND assert_id_verifier "int main( int argc, char** argv ){\n")
list(APPEND assert_id_verifier "  return 0\;\n")
