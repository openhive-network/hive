...
OPTION( HIVE_BUILD_WITH_BLOCKCHAIN "Build with full blockchain support (ON or OFF)" ON )
MESSAGE( STATUS "HIVE_BUILD_WITH_BLOCKCHAIN: ${HIVE_BUILD_WITH_BLOCKCHAIN}" )
if( HIVE_BUILD_WITH_BLOCKCHAIN )
  SET( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DHIVE_BUILD_WITH_BLOCKCHAIN" )
  SET( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -DHIVE_BUILD_WITH_BLOCKCHAIN" )
endif()
