...
from hive_local_tools.functional.python.operation import list_votes_for_all_proposals
from hive_local_tools.functional.python.operation.update_proposal_votes import UpdateProposalVotes


@pytest.mark.testnet()
def test_update_proposal_votes(node, wallet, voter):
...
@pytest.mark.testnet()
def test_cancellation_of_update_proposal_vote(node, wallet, voter):
...
@pytest.mark.testnet()
def test_expiration_of_update_proposal_vote(node, wallet, voter):
