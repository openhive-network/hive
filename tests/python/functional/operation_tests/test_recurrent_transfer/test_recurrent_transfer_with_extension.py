...
def test_recurrent_transfer_with_extension_cases_5_and_6(asset, recurrent_transfer_setup):
    ...
    sender.rc_manabar.assert_rc_current_mana_is_reduced(operation_rc_cost=rtd1.rc_cost,
                                                        operation_timestamp=rtd1.timestamp)
    sender.update_account_info()

    rtd2.update(amount=rtd2.amount - asset(5))
    sender.rc_manabar.assert_rc_current_mana_is_reduced(operation_rc_cost=rtd2.rc_cost,
                                                        operation_timestamp=rtd2.timestamp)
    rtd1.assert_fill_recurrent_transfer_operation_was_generated(expected_vop=3)
    sender.update_account_info()
...
def test_recurrent_transfer_with_extension_cases_11_and_12(node, wallet, sender, receiver, asset):
    ...
    rtd1 = RecurrentTransfer(node, wallet,
                             from_=sender.name,
                             to=receiver.name,
                             amount=rtd1_amount,
    ...
    rtd3 = RecurrentTransfer(node, wallet,
                             from_=sender.name,
                             to=receiver.name,
                             amount=rtd3_amount,
    ...
    sender.rc_manabar.assert_rc_current_mana_is_reduced(operation_rc_cost=rtd3.rc_cost,
                                                        operation_timestamp=rtd3.timestamp)
