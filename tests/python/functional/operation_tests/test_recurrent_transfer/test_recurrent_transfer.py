...
def test_recurrent_transfer_cases_19_and_20(
    node: tt.InitNode, wallet: tt.Wallet, receiver: RecurrentTransferAccount, recurrent_transfer_amount, transfer_amount
):
    """
...
def test_recurrent_transfer_cases_21_and_22(
    node: tt.InitNode, wallet: tt.Wallet, receiver: RecurrentTransferAccount, amount, executions
):
    """
