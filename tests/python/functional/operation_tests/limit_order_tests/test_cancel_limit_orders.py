...
def test_cancel_not_matched_order(
    ...
    alice.assert_rc_current_mana_was_reduced(transaction)
    ...
    bob.assert_rc_current_mana_was_reduced(transaction)
...
def test_cancel_partially_matched_order(
    ...
    carol.assert_rc_current_mana_was_reduced(transaction)
