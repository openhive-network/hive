...
def test_witness_vote(node_with_custom_witnesses, wallet, voter):
    ...
    voter.rc_manabar.assert_rc_current_mana_is_reduced(vote_for_witness_x.transaction)
    ...
    voter.rc_manabar.assert_rc_current_mana_is_reduced(vote_for_witness_y.transaction)
