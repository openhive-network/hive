...
def test_crate_claim_account_token_by_hive(
    ...
    assert alice.get_hive_balance() == alice.hive - fee, "The token creation fee was not charged post account creation."
...
def test_crate_claim_account_token_by_rc(
    ...
    assert (
        initminer.get_hive_balance() == initminer.hive - fee
    ), "The token creation fee was not charged post account creation."
