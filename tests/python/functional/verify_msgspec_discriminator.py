...
if __name__ == "__main__":
    ...
    comment_operation = CommentOperation(parent_author="alice", author="bob", body="body", title="title", permlink="permlink", parent_permlink="parent-permlink", json_metadata="{}")
