...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("condenser", "get_expiring_vesting_delegations", (TOO_LONG_ACCOUNT_NAME, tt.Time.now()), {}),
        ...
        (
            "condenser",
            "list_proposal_votes",
            ([TOO_LONG_ACCOUNT_NAME], 100, "by_voter_proposal", "ascending", "all"),
            {},
        ),
        ...
        (
            ...
            [],
            {"start": [TOO_LONG_ACCOUNT_NAME, "2022-04-11T10:29:00"], "limit": 100},
        ),
        (
            "database",
            "list_account_recovery_requests",
            [],
            {"start": TOO_LONG_ACCOUNT_NAME, "limit": 100, "order": "by_account"},
        ),
        (
            "database",
        ...
        (
            ...
            [],
            {"start": [TOO_LONG_ACCOUNT_NAME, TOO_LONG_ACCOUNT_NAME], "limit": 100, "order": "by_withdraw_route"},
        ),
        (
            "database",
            "list_savings_withdrawals",
            [],
            {"start": ["2022-04-11T10:29:00", TOO_LONG_ACCOUNT_NAME, 0], "limit": 100, "order": "by_complete_from_id"},
        ),
        (
            "database",
            "list_vesting_delegations",
            [],
            {"start": [TOO_LONG_ACCOUNT_NAME, TOO_LONG_ACCOUNT_NAME], "limit": 100, "order": "by_delegation"},
        ),
        (
            "database",
            ...
            [],
            {
                "start": [TOO_LONG_ACCOUNT_NAME, "2022-04-11T10:29:00", 0],
                "limit": 100,
        ...
        (
            ...
            [],
            {"start": [TOO_LONG_ACCOUNT_NAME, 0], "limit": 100, "order": "by_account"},
        ),
        (
            "database",
        ...
        (
            ...
            "list_witness_votes",
            [],
            {"start": [TOO_LONG_ACCOUNT_NAME, TOO_LONG_ACCOUNT_NAME], "limit": 100, "order": "by_witness_account"},
        ),
        (
            "database",
...
@run_for("testnet", enable_plugins=["account_history_api", "reputation_api"])
def test_too_long_account_name_length(node, api, method, arguments, keyword_arguments):
    ...
    assert (
        f"Assert Exception:17131066290140303494: in_len <= sizeof(data): Input too large: `{TOO_LONG_ACCOUNT_NAME}`"
