...
def test_obi_throw_exception_00(prepare_obi_throw_exception_00):
    ...
    ttcn.wait_for_specific_witnesses(witness_node_0, logs, [["witness-1", "initminer"]])
    ...
    ttcn.wait(blocks_wait, logs, witness_node_1)
    ...
    assert ttcn.get_last_head_block_number(_a0) > last_lib_01
