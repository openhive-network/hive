...
@pytest.mark.testnet()
def test_control_queen_by_tx_count(queen_chain_specification: tt.AlternateChainSpecs, queen_node: tt.InitNode) -> None:
    ...
    queen_node.run(alternate_chain_specs=queen_chain_specification)
...
@pytest.mark.testnet()
def test_control_queen_by_block_size(
    queen_chain_specification: tt.AlternateChainSpecs, queen_node: tt.InitNode
) -> None:
