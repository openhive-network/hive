...
def test_update_proposal(node: tt.ApiNode, wallet: tt.OldWallet, funded_account: FundedAccountInfo) -> None:
    ...
    def check_is_proposal_update_exists(block_number: int, end_date: date_type) -> bool:
        ...
        tt.logger.info("Awaiting for blocks to become irreversible")
