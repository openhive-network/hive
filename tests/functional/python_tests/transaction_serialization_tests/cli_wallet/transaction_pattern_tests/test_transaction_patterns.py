...
METHODS_WITH_CORRECT_ARGUMENTS = [
    ...
    ('delegate_vesting_shares_and_transfer_nonblocking', ('alice', 'bob', tt.Asset.Vest(1), tt.Asset.Tbd(6), 'memo',
                                                          False)),
    ...
    ('escrow_transfer', ('initminer', 'alice', 'bob', 10, tt.Asset.Tbd(10), tt.Asset.Test(10), tt.Asset.Tbd(10),
                         '2030-01-01T00:00:00', '2030-06-01T00:00:00', '{}', False)),
