...
def test_join_thread(world):
    #GIVEN
    node_under_test = prepare_nodes(world)
...
def prepare_nodes(world):
    ...
    alpha_witness_node.api.debug_node.debug_switch_witness_production( next = True )
    beta_witness_node.api.debug_node.debug_switch_witness_production( next = True )
    ...
    alpha_witness_node.api.debug_node.debug_switch_witness_production( next = False )
    beta_witness_node.api.debug_node.debug_switch_witness_production( next = False )
