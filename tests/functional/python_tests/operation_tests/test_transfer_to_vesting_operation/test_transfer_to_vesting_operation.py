...
def test_transfer_vests(prepared_node, wallet, sender, receiver):
    ...
    __assert_virtual_operation_was_generated(prepared_node, "transfer_to_vesting_completed_operation",
                                             expected_number_of_virtual_operations=1)
    __assert_governance_voting_power_is_not_increased(prepared_node, wallet, receiver, initial_governance_voting_power=0)
    ...
    # Jump to day 29
    jump_to_date(prepared_node, operation_timestamp + timedelta(
    ...
    __assert_virtual_operation_was_generated(prepared_node, "delayed_voting_operation", expected_number_of_virtual_operations=2)
...
def test_transfer_vests_twice(prepared_node, wallet):
    ...
    __assert_power_up_exchange_rate(prepared_node, receiver, first_amount + second_amount, price_after_time_change, tolerance=5)
    __assert_virtual_operation_was_generated(prepared_node, "transfer_to_vesting_completed_operation",
    ...
    jump_to_date(prepared_node, initial_time_first_operation + timedelta(
        seconds=DELAYED_VOTING_TOTAL_INTERVAL_SECONDS - DELAYED_VOTING_INTERVAL_SECONDS))
    ...
    __assert_governance_voting_power_is_not_increased(prepared_node, wallet, receiver,
    ...
    __assert_governance_voting_power_is_increased(prepared_node, wallet, receiver,
                                                  initial_governance_voting_power=governance_voting_power)
    # The first virtual operation `delayed_voting_operation` is generated during the preparation of the test environment
    __assert_virtual_operation_was_generated(prepared_node, "delayed_voting_operation", expected_number_of_virtual_operations=3)
