...
def test_import_keys(unconfigured_online_wallet, node):
    unconfigured_online_wallet.api.set_password(unconfigured_online_wallet.DEFAULT_PASSWORD)
    unconfigured_online_wallet.api.unlock(unconfigured_online_wallet.DEFAULT_PASSWORD)
