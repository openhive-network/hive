...
# aliasing so pytest won't execute this test
from .basic_proposal_test import test_create_proposal as create_proposal
from .basic_proposal_test import test_update_proposal_votes as create_proposal_with_votes
