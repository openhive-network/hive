...
def test_run_method_with_additional_argument(node, api_database_method, arguments, additional_argument):
    getattr(node.api.database, api_database_method)(**arguments, arg=additional_argument)
