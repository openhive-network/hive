...
def test_trigger_undo_with_witnesses(world):
    #GIVEN
...
def make_fork(world, fork_number):
    ...
    alpha_witness_node.wait_for_block_with_number(head_block + 10)
    beta_witness_node.wait_for_block_with_number(head_block + 10)
    alpha_net.connect_with(beta_net)
    alpha_witness_node.wait_for_block_with_number(head_block + 20)
    beta_witness_node.wait_for_block_with_number(head_block + 20)
