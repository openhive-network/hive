...
from .utilities import create_accounts, check_recurrent_transfer, check_recurrent_transfer_data
...
def test_recurrent_transfer(wallet):
    ...
    check_recurrent_transfer( _result[0], 'alice', 'bob', tt.Asset.Test(20), 'banana-cherry', 24, 'remaining_executions', 2, 0 )
    ...
    assert len(_result) == 1
    check_recurrent_transfer( _result[0], 'bob', 'alice', tt.Asset.Test(0.9), 'banana-lime', 25, 'remaining_executions', 1, 0 )
    ...
    check_recurrent_transfer( _result[0], 'bob', 'alice', tt.Asset.Test(0.9), 'banana-lime', 25, 'remaining_executions', 1, 0 )
    check_recurrent_transfer( _result[1], 'bob', 'initminer', tt.Asset.Test(0.8), 'banana-lemon', 26, 'remaining_executions', 21, 0 )
