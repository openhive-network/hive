...
@run_for("testnet")
def test_declining_voting_rights_after_the_required_time_has_elapsed(prepare_environment):
...
@run_for("testnet")
def test_declining_voting_rights_more_than_once_in_a_row(prepare_environment):
    node, wallet = prepare_environment
...
@run_for("testnet")
def test_remove_a_declining_voting_rights_request(prepare_environment):
    node, wallet = prepare_environment
