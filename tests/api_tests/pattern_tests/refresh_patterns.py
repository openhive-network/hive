...
engine.add_argument(
    ...
    type=str,
    default=None,
    help="this suffix will be attached to file extension, which is handy for fast removal of patterns (Ex. \"xxx\", which allows to execute command: `find . | grep 'json.xxx' | xargs rm` )",
)
engine.add_argument(
    "-p",
    "--pattern",
