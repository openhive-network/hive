...
def prepared_node(request):
    def __create_init_node():
        ...
        if request.node.get_closest_marker('prepare_witnesses_in_node_config'):
            witnesses_names = request.node.get_closest_marker('prepare_witnesses_in_node_config').args[0]
    ...
    create_node = {
        ...
        'mainnet_5m': lambda: tt.RemoteNode(http_endpoint='http://hive-3.pl.syncad.com:18092'),
        'mainnet_64m': lambda: tt.RemoteNode(http_endpoint='http://hive-6.pl.syncad.com:8092'),
    }
