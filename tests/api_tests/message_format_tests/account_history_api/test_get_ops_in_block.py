...
@pytest.mark.parametrize(
    'block_num, virtual_operation, include_reversible', [
        ...
        ('1', True, True),
        (1.1, True, True),
        (True, True, True),  # block number given as bool is converted to number (True:1, False:0)
        (None, True, True),  # block number given as None is converted to number 0
        ...
        (1, False, True),
        (1, None, True),  # None its converted do number 0
        (1, 0, True),  # numeric in virtual operations is converted to bool
        (1, 1, True),
        (1, 2, True),
