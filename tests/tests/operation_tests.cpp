...
BOOST_AUTO_TEST_CASE( account_create_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( acct.get_sbd_balance().amount.value == ASSET( "0.000 TBD" ).amount.value );
      BOOST_REQUIRE( acct.id._id == acct_auth.id._id );

      BOOST_REQUIRE( acct.get_vesting_shares().amount.value == 0 );
      ...
      tx.signatures.clear();
      tx.operations.clear();
      op.fee = asset( get_balance( STEEM_INIT_MINER_NAME ).amount + 1, STEEM_SYMBOL );
      op.new_account_name = "bob";
      tx.operations.push_back( op );
      sign( tx, init_account_priv_key );
...
BOOST_AUTO_TEST_CASE( transfer_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( get_balance( STEEM_TREASURY_ACCOUNT ) == ASSET( "0.000 TESTS" ) );
      validate_database();

      BOOST_TEST_MESSAGE( "--- Test transfering HBD to steem.dao" );
      auto treasury_sbd_balance = get_sbd_balance( STEEM_TREASURY_ACCOUNT );
      ...
      BOOST_REQUIRE( get_sbd_balance( "bob" ) == ASSET( "0.000 TBD" ) );
      BOOST_REQUIRE( get_sbd_balance( STEEM_TREASURY_ACCOUNT ) == treasury_sbd_balance + ASSET( "1.000 TBD" ) );
      validate_database();
   }
   FC_LOG_AND_RETHROW()
}
...
BOOST_AUTO_TEST_CASE( withdraw_vesting_apply )
{
   try
   {
      ...
      op.vesting_shares = asset( alice.get_vesting_shares().amount / 2, VESTS_SYMBOL );

      auto old_vesting_shares = alice.get_vesting_shares();
      ...
      BOOST_REQUIRE( alice.get_vesting_shares().amount.value == old_vesting_shares.amount.value );
      ...
      op.vesting_shares = asset( alice.get_vesting_shares().amount / 3, VESTS_SYMBOL );
      tx.operations.push_back( op );
      tx.set_expiration( db->head_block_time() + STEEM_MAX_TIME_UNTIL_EXPIRATION );
      sign( tx, alice_private_key );
      db->push_transaction( tx, 0 );
      ...
      op.vesting_shares = alice.get_vesting_shares();
      tx.clear();
      tx.operations.push_back( op );
      sign( tx, alice_private_key );
      db->push_transaction( tx, 0 );
      ...
      db_plugin->debug_update( [=]( database& db )
      {
         ...
         db.modify( db.get_dynamic_global_properties(), [&]( dynamic_global_property_object& gpo )
         {
            ...
            gpo.get_total_vesting_fund_steem().transfer_to( &steem_balance );
            gpo.burn_steem( &steem_balance, steem_balance );
            gpo.issue_steem( &steem_balance, wso.median_props.account_creation_fee - ASSET( "0.001 TESTS" ) );
...
BOOST_AUTO_TEST_CASE( account_witness_vote_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( sam_witness.votes == alice.get_vesting_shares().amount );
      ...
      BOOST_REQUIRE( sam_witness.votes == ( bob.proxied_vsf_votes_total() + bob.get_vesting_shares().amount ) );
...
BOOST_AUTO_TEST_CASE( account_witness_proxy_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( alice.proxied_vsf_votes_total() == bob.get_vesting_shares().amount );
      validate_database();
      ...
      BOOST_REQUIRE( sam.proxied_vsf_votes_total().value == bob.get_vesting_shares().amount );
      validate_database();
      ...
      BOOST_REQUIRE( bob.proxied_vsf_votes_total().value == 0 );
      BOOST_REQUIRE( sam.proxy == STEEM_PROXY_TO_SELF_ACCOUNT );
      BOOST_REQUIRE( sam.proxied_vsf_votes_total() == bob.get_vesting_shares().amount );
      validate_database();
      ...
      BOOST_REQUIRE( dave.proxied_vsf_votes_total() == ( sam.get_vesting_shares() + bob.get_vesting_shares() ).amount );
      validate_database();
      ...
      BOOST_REQUIRE( bob.proxied_vsf_votes_total().value == 0 );
      BOOST_REQUIRE( sam.proxy == "dave" );
      BOOST_REQUIRE( sam.proxied_vsf_votes_total() == ( bob.get_vesting_shares() + alice.get_vesting_shares() ).amount );
      BOOST_REQUIRE( dave.proxy == STEEM_PROXY_TO_SELF_ACCOUNT );
      BOOST_REQUIRE( dave.proxied_vsf_votes_total() == ( sam.get_vesting_shares() + bob.get_vesting_shares() + alice.get_vesting_shares() ).amount );
      validate_database();
      ...
      BOOST_REQUIRE( bob.proxied_vsf_votes_total().value == 0 );
      BOOST_REQUIRE( sam.proxy == "dave" );
      BOOST_REQUIRE( sam.proxied_vsf_votes_total() == alice.get_vesting_shares().amount );
      BOOST_REQUIRE( dave.proxy == STEEM_PROXY_TO_SELF_ACCOUNT );
      BOOST_REQUIRE( dave.proxied_vsf_votes_total() == ( sam.get_vesting_shares() + alice.get_vesting_shares() ).amount );
      validate_database();
      ...
      BOOST_REQUIRE( db->get_witness( STEEM_INIT_MINER_NAME ).votes == ( alice.get_vesting_shares() + bob.get_vesting_shares() ).amount );
      validate_database();
      ...
      BOOST_REQUIRE( db->get_witness( STEEM_INIT_MINER_NAME ).votes == bob.get_vesting_shares().amount );
      validate_database();
   }
   FC_LOG_AND_RETHROW()
}
...
BOOST_AUTO_TEST_CASE( convert_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( new_bob.get_sbd_balance().amount.value == ASSET( "7.000 TBD" ).amount.value );
      validate_database();
      ...
      BOOST_REQUIRE( new_alice.get_sbd_balance().amount.value == ASSET( "2.500 TBD" ).amount.value );
      validate_database();
      ...
      BOOST_REQUIRE( new_bob.get_balance().amount.value == ASSET( "3.000 TESTS" ).amount.value );
      BOOST_REQUIRE( new_bob.get_sbd_balance().amount.value == ASSET( "4.000 TBD" ).amount.value );
      ...
      BOOST_REQUIRE( convert_request->get_amount().amount.value == op.amount.amount.value );
      ...
      BOOST_REQUIRE( convert_request->owner == op.owner );
      BOOST_REQUIRE( convert_request->requestid == op.requestid );
      BOOST_REQUIRE( convert_request->get_amount().amount.value == ASSET( "3.000 TBD" ).amount.value );
      //BOOST_REQUIRE( convert_request->premium == 100000 );
      BOOST_REQUIRE( convert_request->conversion_date == db->head_block_time() + STEEM_CONVERSION_DELAY );
      validate_database();
   }
...
BOOST_AUTO_TEST_CASE( limit_order_create_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( bob.get_balance().amount.value == ASSET( "0.000 TESTS" ).amount.value );
      BOOST_REQUIRE( bob.get_sbd_balance().amount.value == ASSET( "1000.000 TBD" ).amount.value );
      validate_database();
      ...
      BOOST_REQUIRE( alice.get_sbd_balance().amount.value == ASSET( "0.000 TBD" ).amount.value );
      validate_database();
      ...
      BOOST_REQUIRE( limit_order_idx.find( boost::make_tuple( "bob", op.orderid ) ) == limit_order_idx.end() );
      BOOST_REQUIRE( alice.get_balance().amount.value == ASSET( "990.000 TESTS" ).amount.value );
      BOOST_REQUIRE( alice.get_sbd_balance().amount.value == ASSET( "7.500 TBD" ).amount.value );
      BOOST_REQUIRE( bob.get_balance().amount.value == ASSET( "5.000 TESTS" ).amount.value );
      BOOST_REQUIRE( bob.get_sbd_balance().amount.value == ASSET( "992.500 TBD" ).amount.value );
      ...
      BOOST_REQUIRE( alice.get_balance().amount.value == ASSET( "990.000 TESTS" ).amount.value );
      BOOST_REQUIRE( alice.get_sbd_balance().amount.value == ASSET( "15.000 TBD" ).amount.value );
      BOOST_REQUIRE( bob.get_balance().amount.value == ASSET( "10.000 TESTS" ).amount.value );
      BOOST_REQUIRE( bob.get_sbd_balance().amount.value == ASSET( "977.500 TBD" ).amount.value );
      validate_database();
      ...
      BOOST_REQUIRE( alice.get_sbd_balance().amount.value == ASSET( "22.500 TBD" ).amount.value );
      ...
      BOOST_REQUIRE( alice.get_sbd_balance().amount.value == ASSET( "33.500 TBD" ).amount.value );
      BOOST_REQUIRE( bob.get_balance().amount.value == ASSET( "25.000 TESTS" ).amount.value );
      BOOST_REQUIRE( bob.get_sbd_balance().amount.value == ASSET( "965.500 TBD" ).amount.value );
      validate_database();
      ...
      BOOST_REQUIRE( alice.get_sbd_balance().amount.value == ASSET( "45.500 TBD" ).amount.value );
      BOOST_REQUIRE( bob.get_balance().amount.value == ASSET( "35.909 TESTS" ).amount.value );
      BOOST_REQUIRE( bob.get_sbd_balance().amount.value == ASSET( "954.500 TBD" ).amount.value );
      validate_database();
   }
   FC_LOG_AND_RETHROW()
}
...
BOOST_AUTO_TEST_CASE( limit_order_create2_apply )
{
   try
   {
      ...
      */
      ...
      BOOST_REQUIRE( limit_order->seller == "alice" );
      BOOST_REQUIRE( limit_order->orderid == 6 );
      BOOST_REQUIRE( limit_order->amount_for_sale().amount.value == 20000 );
...
BOOST_AUTO_TEST_CASE( escrow_transfer_apply )
{
   try
   {
      ...
      auto alice_steem_balance = alice.get_balance() - op.steem_amount - op.fee;
      auto alice_sbd_balance = alice.get_sbd_balance() - op.sbd_amount;
      auto bob_steem_balance = bob.get_balance();
      auto bob_sbd_balance = bob.get_sbd_balance();
      auto sam_steem_balance = sam.get_balance();
      auto sam_sbd_balance = sam.get_sbd_balance();
      ...
      BOOST_REQUIRE( escrow.get_sbd_balance() == op.sbd_amount );
      BOOST_REQUIRE( escrow.get_steem_balance() == op.steem_amount );
      ...
      BOOST_REQUIRE( alice.get_balance() == alice_steem_balance );
      BOOST_REQUIRE( alice.get_sbd_balance() == alice_sbd_balance );
      BOOST_REQUIRE( bob.get_balance() == bob_steem_balance );
      BOOST_REQUIRE( bob.get_sbd_balance() == bob_sbd_balance );
      BOOST_REQUIRE( sam.get_balance() == sam_steem_balance );
      BOOST_REQUIRE( sam.get_sbd_balance() == sam_sbd_balance );
...
BOOST_AUTO_TEST_CASE( escrow_approve_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( escrow.get_sbd_balance() == ASSET( "0.000 TBD" ) );
      BOOST_REQUIRE( escrow.get_steem_balance() == ASSET( "1.000 TESTS" ) );
...
BOOST_AUTO_TEST_CASE( escrow_dispute_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( escrow.ratification_deadline == et_op.ratification_deadline );
      BOOST_REQUIRE( escrow.escrow_expiration == et_op.escrow_expiration );
      BOOST_REQUIRE( escrow.get_sbd_balance() == et_op.sbd_amount );
      BOOST_REQUIRE( escrow.get_steem_balance() == et_op.steem_amount );
...
BOOST_AUTO_TEST_CASE( escrow_release_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( db->get_escrow( op.from, op.escrow_id ).get_steem_balance() == ASSET( "0.900 TESTS" ) );
      ...
      BOOST_REQUIRE( db->get_escrow( op.from, op.escrow_id ).get_steem_balance() == ASSET( "0.800 TESTS" ) );
      ...
      BOOST_REQUIRE( db->get_escrow( et_op.from, et_op.escrow_id ).get_steem_balance() == ASSET( "0.700 TESTS" ) );
      ...
      BOOST_REQUIRE( db->get_escrow( et_op.from, et_op.escrow_id ).get_steem_balance() == ASSET( "0.600 TESTS" ) );
      ...
      BOOST_REQUIRE( db->get_escrow( et_op.from, et_op.escrow_id ).get_steem_balance() == ASSET( "0.500 TESTS" ) );
      ...
      BOOST_REQUIRE( db->get_escrow( et_op.from, et_op.escrow_id ).get_steem_balance() == ASSET( "0.900 TESTS" ) );
      ...
      BOOST_REQUIRE( db->get_escrow( et_op.from, et_op.escrow_id ).get_steem_balance() == ASSET( "0.800 TESTS" ) );
...
BOOST_AUTO_TEST_CASE( transfer_to_savings_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( get_balance( "alice" ) == ASSET( "10.000 TESTS" ) );
      BOOST_REQUIRE( get_sbd_balance( "alice" ) == ASSET( "10.000 TBD" ) );
      ...
      BOOST_REQUIRE( get_sbd_balance( "alice" ) == ASSET( "9.000 TBD" ) );
      BOOST_REQUIRE( get_sbd_savings( "alice" ) == ASSET( "1.000 TBD" ) );
      validate_database();
      ...
      BOOST_REQUIRE( get_sbd_balance( "alice" ) == ASSET( "8.000 TBD" ) );
      BOOST_REQUIRE( get_sbd_savings( "bob" ) == ASSET( "1.000 TBD" ) );
      validate_database();
   }
   FC_LOG_AND_RETHROW()
}
...
BOOST_AUTO_TEST_CASE( transfer_from_savings_apply )
{
   try
   {
      ...
      sign( tx, alice_private_key );
      db->push_transaction( tx, 0 );
      BOOST_REQUIRE( get_sbd_savings( "alice" ) == ASSET( "9.000 TBD" ) );
      validate_database();
      ...
      BOOST_REQUIRE( db->get_savings_withdraw( "alice", op.request_id ).get_amount() == op.amount );
      ...
      BOOST_REQUIRE( get_sbd_balance( "alice" ) == ASSET( "0.000 TBD" ) );
      BOOST_REQUIRE( get_sbd_savings( "alice" ) == ASSET( "8.000 TBD" ) );
      BOOST_REQUIRE( db->get_account( "alice" ).savings_withdraw_requests == op.request_id + 1 );
      BOOST_REQUIRE( db->get_savings_withdraw( "alice", op.request_id ).from == op.from );
      BOOST_REQUIRE( db->get_savings_withdraw( "alice", op.request_id ).to == op.to );
      BOOST_REQUIRE( to_string( db->get_savings_withdraw( "alice", op.request_id ).memo ) == op.memo );
      ...
      BOOST_REQUIRE( get_sbd_balance( "alice" ) == ASSET( "0.000 TBD" ) );
      BOOST_REQUIRE( get_sbd_savings( "alice" ) == ASSET( "7.000 TBD" ) );
      BOOST_REQUIRE( db->get_account( "alice" ).savings_withdraw_requests == op.request_id + 1 );
      BOOST_REQUIRE( db->get_savings_withdraw( "alice", op.request_id ).from == op.from );
      BOOST_REQUIRE( db->get_savings_withdraw( "alice", op.request_id ).to == op.to );
      BOOST_REQUIRE( to_string( db->get_savings_withdraw( "alice", op.request_id ).memo ) == op.memo );
      ...
      BOOST_REQUIRE( get_sbd_balance( "alice" ) == ASSET( "1.000 TBD" ) );
      BOOST_REQUIRE( get_balance( "bob" ) == ASSET( "1.000 TESTS" ) );
      BOOST_REQUIRE( get_sbd_balance( "bob" ) == ASSET( "1.000 TBD" ) );
...
BOOST_AUTO_TEST_CASE( claim_reward_balance_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( get_balance( "alice" ) == alice_steem + op.reward_steem );
...
BOOST_AUTO_TEST_CASE( comment_beneficiaries_apply )
{
   try
   {
      ...
      db_plugin->debug_update( [=]( database& db )
      {
         ...
         {
            TTempBalance steem_balance( STEEM_SYMBOL );
            gpo.get_total_reward_fund_steem().transfer_to( &steem_balance );
            gpo.burn_steem( &steem_balance, steem_balance );
            gpo.issue_steem( &steem_balance, ASSET( "100.000 TESTS" ) );
            gpo.get_total_reward_fund_steem().transfer_from( &steem_balance );
         });
      });

      generate_block();

      BOOST_REQUIRE( db->get_account( "bob" ).reward_vesting_steem.amount + get_sbd_rewards( "bob" ).amount + db->get_account( "sam" ).reward_vesting_steem.amount + get_sbd_rewards( "sam" ).amount + get_sbd_balance( STEEM_TREASURY_ACCOUNT ).amount == db->get_comment( "alice", string( "test" ) ).beneficiary_payout_value.amount );
      BOOST_REQUIRE( ( get_sbd_rewards( "alice" ).amount + db->get_account( "alice" ).reward_vesting_steem.amount + get_sbd_balance( STEEM_TREASURY_ACCOUNT ).amount ) == db->get_account( "bob" ).reward_vesting_steem.amount + get_sbd_rewards( "bob" ).amount + 1 );
      BOOST_REQUIRE( ( get_sbd_rewards( "alice" ).amount + db->get_account( "alice" ).reward_vesting_steem.amount + get_sbd_balance( STEEM_TREASURY_ACCOUNT ).amount ) == ( db->get_account( "sam" ).reward_vesting_steem.amount + get_sbd_rewards( "sam" ).amount ) / 2 + 1 );
      BOOST_REQUIRE( db->get_account( "bob" ).reward_vesting_steem.amount == get_sbd_rewards( "bob" ).amount + 1 );
      BOOST_REQUIRE( db->get_account( "sam" ).reward_vesting_steem.amount == get_sbd_rewards( "sam" ).amount + 1 );
   }
   FC_LOG_AND_RETHROW()
}
...
BOOST_AUTO_TEST_CASE( claim_account_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( get_balance( STEEM_NULL_ACCOUNT ) == ASSET( "5.000 TESTS" ) );
...
BOOST_AUTO_TEST_CASE( create_claimed_account_apply )
{
   try
   {
      ...
      BOOST_REQUIRE( bob.get_balance().amount.value == ASSET( "0.000 TESTS" ).amount.value );
      BOOST_REQUIRE( bob.get_sbd_balance().amount.value == ASSET( "0.000 TBD" ).amount.value );
      BOOST_REQUIRE( bob.get_vesting_shares().amount.value == ASSET( "0.000000 VESTS" ).amount.value );
