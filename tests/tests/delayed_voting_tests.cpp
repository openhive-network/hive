   ...
   try
   {
...

      {
         ...
         */
         ...
         ++minutes;
         generate_blocks( start_time + fc::minutes( minutes ), true );
         auto _v1 = vamount( _1 );
         vest( "alice", "alice", _1, alice_private_key );
      ...
      */
...

      {
         ...
         */
         ...
         fill( proxy_30, "alice", day, minutes );
         generate_block();
         ...
         fill( proxy_30, "celine", day, minutes );
         generate_block();
...

      {
         ...
         */
         ...
         fill( proxy_31, "celine", day, minutes );
         generate_block();
      }
      {
         /*
