...
if __name__ == '__main__':
    ...
    try:
        if node is None or node.is_running():
            ...
            proposal_data = [
                ['tester001', 1 + 0, 1, '24.000 HBD'], # starts 1 day from now and lasts 1 day
                ['tester002', 1 + 1, 1, '24.000 HBD'], # starts 2 days from now and lasts 1 day
                ['tester003', 1 + 2, 1, '24.000 HBD'],  # starts 3 days from now and lasts 1 day
                ['tester004', 1 + 0, 3, '240000.000 HBD'], # starts one day from now and lasts 3 days
            ]
            ...
            balances = test_utils.print_balance(node_client, accounts)
            # it should be '414.000 HBD', '414.000 HBD', '414.000 HBD', '29879.682 HBD',
            # but but because of rounding implementationit is 413.952 HBD,413.952 HBD,413.952 HBD,29833.225 HBD
            test_balances = [
                '413952',
                '413952',
                '413952',
