...
result_01, digest_01 = example.calculate_digest(trx_01)
print( f"{trx_01} = result: {result_01} digest: {digest_01}" )
print("====================================================================")

trx_00 = b'{}'
result_00, digest_00 = example.calculate_digest(trx_00)
print( f"{trx_00} = result: {result_00} digest: {digest_00}" )
print("====================================================================")
