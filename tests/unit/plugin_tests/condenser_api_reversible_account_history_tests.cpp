...
BOOST_AUTO_TEST_CASE( get_account_history_reversible_comment_and_reward )
{ try {

  BOOST_TEST_MESSAGE( "testing reversible get_account_history with comment_and_reward_scenario" );
