...
{ try {
  ...
  BOOST_REQUIRE_EQUAL( all_scheduled_witnesses_1.witnesses.size(), 2 * HIVE_MAX_WITNESSES );
  ...
  for( int i = 0; i < HIVE_MAX_WITNESSES; ++i )
    BOOST_REQUIRE_EQUAL( active_schedule_2.current_shuffled_witnesses[i], full_schedule_1.current_shuffled_witnesses[i+HIVE_MAX_WITNESSES] );
