...
{ try {
  ...
  auto check_point_tester2 = [ this ]( uint32_t generate_no_further_than )
  {
    ...
    expected_t expected_operations = { { // account_witness_proxy_operation
      ...
      R"~({"trx_id":"b69d5a7e8bf07e64a302153228ee9cfd69da36b0","block":3,"trx_in_block":4,"op_in_trx":0,"virtual_op":false,"timestamp":"2016-01-01T00:00:09","op":{"type":"delegate_vesting_shares_operation","value":{"delegator":"alice12ah","delegatee":"ben12ah","vesting_shares":{"amount":"1507","precision":6,"nai":"@@000000037"}}},"operation_id":0})~",
      R"~({"trx_id":"b69d5a7e8bf07e64a302153228ee9cfd69da36b0","block":3,"trx_in_block":4,"op_in_trx":0,"virtual_op":false,"timestamp":"2016-01-01T00:00:09","op":["delegate_vesting_shares",{"delegator":"alice12ah","delegatee":"ben12ah","vesting_shares":"0.001507 VESTS"}]})~"
      }, { // comment_operation
