...
BOOST_AUTO_TEST_CASE( database_api_negative )
{
  try
  {
    ...
    message = "Assert Exception:17646470541266929066: 0 < args.accounts.size() && args.accounts.size() <= DATABASE_API_SINGLE_QUERY_LIMIT: list of accounts to find not filled or too big";
    ...
    message = "Assert Exception:17497937829563865090: 0 < args.limit && args.limit <= DATABASE_API_SINGLE_QUERY_LIMIT: limit not set or too big";
    ...
    // order not set
    message = "Assert Exception:3658472883277130625: false: Unknown or unsupported sort order 'not_set'";
