...
BOOST_AUTO_TEST_CASE( undo_basic )
{
  try
  {
    ...
    BOOST_REQUIRE_EQUAL( std::string( obj0.get_name() ), "name00" );
    ...
    BOOST_REQUIRE_EQUAL( std::string( obj1.get_name() ), "name00" );
    const auto& obj2 = ao.modify( obj1, [&]( account_object& obj ){ obj.set_name( "name01" ); } );
    BOOST_REQUIRE_EQUAL( std::string( obj2.get_name() ), "name01" );
    ...
    ao.remove( obj3 );
    ao.remove<account_index>( obj3.get_name() );
    ...
    ao.remove( obj5 );
    ao.remove<account_index>( obj5.get_name() );
    ...
    BOOST_REQUIRE_EQUAL( std::string( obj_c.get_name() ), "name00" );

    const auto& obj_cm = ao.create( "name01", time );
    BOOST_REQUIRE_EQUAL( std::string( obj_cm.get_name() ), "name01" );
    ...
    BOOST_REQUIRE_EQUAL( std::string( obj_cr.get_name() ), "name03" );
    ao.remove( obj_cr );
    ao.remove<account_index>( obj_cr.get_name() );
...
BOOST_AUTO_TEST_CASE( undo_different_indexes )
{
  try
  {
    ...
    BOOST_REQUIRE_EQUAL( std::string( obja0.get_name() ), "name00" );
