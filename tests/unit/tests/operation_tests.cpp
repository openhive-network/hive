...
BOOST_AUTO_TEST_CASE( vote_apply )
{
  try
  {
    ...
    BOOST_REQUIRE( _alice_assets.get_last_vote_time() == db->head_block_time() );
    BOOST_REQUIRE( alice_comment_cashout->get_net_rshares() == ( old_mana - _alice_assets.get_voting_manabar().current_mana ) - HIVE_VOTE_DUST_THRESHOLD );
    ...
    BOOST_REQUIRE( itr->get_rshares() == ( old_mana - _alice_assets.get_voting_manabar().current_mana ) - HIVE_VOTE_DUST_THRESHOLD );
    validate_database();
    ...
    BOOST_REQUIRE( bob_comment_cashout->get_net_rshares() == ( old_manabar.current_mana - _alice_assets.get_voting_manabar().current_mana ) - HIVE_VOTE_DUST_THRESHOLD );
    BOOST_REQUIRE( bob_comment_cashout->get_cashout_time() == bob_comment_cashout->get_creation_time() + HIVE_CASHOUT_WINDOW_SECONDS );
    BOOST_REQUIRE( itr != vote_idx.end() );
    validate_database();
    ...
    BOOST_REQUIRE( alice_comment_cashout->get_net_rshares() == old_net_rshares + ( old_mana - _bob_assets.get_voting_manabar().current_mana ) - HIVE_VOTE_DUST_THRESHOLD );
    BOOST_REQUIRE( alice_comment_cashout->get_cashout_time() == alice_comment_cashout->get_creation_time() + HIVE_CASHOUT_WINDOW_SECONDS );
    BOOST_REQUIRE( itr != vote_idx.end() );
    validate_database();
    ...
    BOOST_REQUIRE( _alice_assets.get_downvote_manabar().current_mana == 0 );
    BOOST_REQUIRE( _alice_assets.get_voting_manabar().current_mana == old_manabar.current_mana - alice_weight + old_downvote_manabar.current_mana );
    validate_database();
...
BOOST_AUTO_TEST_CASE( transfer_apply )
{
  try
  {
    ...
    BOOST_REQUIRE( new_alice_assets.get_balance().amount.value == ASSET( "5.000 TESTS" ).amount.value );
    BOOST_REQUIRE( new_bob_assets.get_balance().amount.value == ASSET( "5.000 TESTS" ).amount.value );
    validate_database();
    ...
    BOOST_REQUIRE( new_alice_assets.get_balance().amount.value == ASSET( "0.000 TESTS" ).amount.value );
    BOOST_REQUIRE( new_bob_assets.get_balance().amount.value == ASSET( "10.000 TESTS" ).amount.value );
    validate_database();
    ...
    BOOST_REQUIRE( treasury_assets.get_hbd_balance() == treasury_hbd_balance + ASSET( "1.000 TBD" ) );
    generate_block();
    validate_database();
...
BOOST_AUTO_TEST_CASE( transfer_to_vesting_apply )
{
  try
  {
    ...
    BOOST_REQUIRE( alice_assets.get_balance() == ASSET( "10.000 TESTS" ) );
    ...
    BOOST_REQUIRE( alice_assets.get_balance().amount.value == ASSET( "2.500 TESTS" ).amount.value );
    BOOST_REQUIRE( alice_assets.get_vesting().amount.value == alice_shares.amount.value );
    ...
    BOOST_REQUIRE( alice_assets.get_balance().amount.value == ASSET( "0.500 TESTS" ).amount.value );
    BOOST_REQUIRE( alice_assets.get_vesting().amount.value == alice_shares.amount.value );
    BOOST_REQUIRE( bob_assets.get_balance().amount.value == ASSET( "0.000 TESTS" ).amount.value );
    BOOST_REQUIRE( bob_assets.get_vesting().amount.value == bob_shares.amount.value );
    BOOST_REQUIRE( gpo.get_total_vesting_fund_hive().amount.value == vests.amount.value );
    BOOST_REQUIRE( gpo.get_total_vesting_shares().amount.value == shares.amount.value );
    validate_database();
...
BOOST_AUTO_TEST_CASE( witness_update_apply )
{
  try
  {
    ...
    BOOST_REQUIRE( alice_assets.get_balance().amount.value == ASSET( "10.000 TESTS" ).amount.value ); // No fee
    validate_database();
    ...
    BOOST_REQUIRE( alice_witness.virtual_position == 0 );
    BOOST_REQUIRE( alice_witness.virtual_scheduled_time == fc::uint128_max_value() );
    BOOST_REQUIRE( alice_assets.get_balance().amount.value == ASSET( "10.000 TESTS" ).amount.value );
    validate_database();
...
BOOST_AUTO_TEST_CASE(account_witness_vote_apply_delay)
{
  ...
  try
  {
    ...
    BOOST_REQUIRE(_alice_assets.get_vesting().amount == _alice_dv.get_sum_delayed_votes().value);
    ...
    BOOST_REQUIRE(_sam_witness.votes == _alice_assets.get_vesting().amount);
    BOOST_REQUIRE(_alice_dv.get_sum_delayed_votes() == 0);
    validate_database();
    ...
    BOOST_REQUIRE(_alice_assets.get_vesting().amount == _bob.proxied_vsf_votes_total());
    BOOST_REQUIRE(_sam_witness.votes == (_alice_assets.get_vesting().amount + _bob_assets.get_vesting().amount));
...
BOOST_AUTO_TEST_CASE( account_witness_proxy_apply_delay )
{
  ...
  try
  {
    ...
    validate_database();
    generate_blocks(db->head_block_time() + fc::seconds(HIVE_DELAYED_VOTING_TOTAL_INTERVAL_SECONDS));
    BOOST_REQUIRE(_alice.proxied_vsf_votes_total() == _bob_assets.get_vesting().amount);
    ...
    BOOST_REQUIRE( _sam.proxied_vsf_votes_total().value == _bob_assets.get_vesting().amount );
    validate_database();
    ...
    BOOST_REQUIRE( _bob.proxied_vsf_votes_total().value == 0 );
    CHECK_NO_PROXY( _sam );
    BOOST_REQUIRE( _sam.proxied_vsf_votes_total() == _bob_assets.get_vesting().amount );
    validate_database();
    ...
    BOOST_REQUIRE( _dave.proxied_vsf_votes_total() == ( _sam_assets.get_vesting() + _bob_assets.get_vesting() ).amount );
    validate_database();
    ...
    BOOST_REQUIRE( _bob.proxied_vsf_votes_total().value == 0 );
    CHECK_PROXY( _sam, _dave );
    BOOST_REQUIRE( _sam.proxied_vsf_votes_total() == ( _bob_assets.get_vesting() + _alice_assets.get_vesting() ).amount );
    CHECK_NO_PROXY( _dave );
    BOOST_REQUIRE( _dave.proxied_vsf_votes_total() == ( _sam_assets.get_vesting() + _bob_assets.get_vesting() + _alice_assets.get_vesting() ).amount );
    validate_database();
    ...
    BOOST_REQUIRE( _bob.proxied_vsf_votes_total().value == 0 );
    CHECK_PROXY( _sam, _dave );
    BOOST_REQUIRE( _sam.proxied_vsf_votes_total() == _alice_assets.get_vesting().amount );
    CHECK_NO_PROXY( _dave );
    BOOST_REQUIRE( _dave.proxied_vsf_votes_total() == ( _sam_assets.get_vesting() + _alice_assets.get_vesting() ).amount );
    validate_database();
    ...
    BOOST_REQUIRE( db->get_witness( HIVE_INIT_MINER_NAME ).votes == ( _alice_assets.get_vesting() + _bob_assets.get_vesting() ).amount );
    validate_database();
    ...
    BOOST_REQUIRE( db->get_witness( HIVE_INIT_MINER_NAME ).votes == _bob_assets.get_vesting().amount );
    validate_database();
  }
  FC_LOG_AND_RETHROW()
}
...
BOOST_AUTO_TEST_CASE( convert_apply )
{
  try
  {
    ...
    BOOST_REQUIRE( new_bob_assets.get_balance().amount.value == ASSET( "3.000 TESTS" ).amount.value );
    BOOST_REQUIRE( new_bob_assets.get_hbd_balance().amount.value == ASSET( "7.000 TBD" ).amount.value );
    validate_database();
    ...
    BOOST_REQUIRE( new_alice_assets.get_balance().amount.value == ASSET( "7.500 TESTS" ).amount.value );
    BOOST_REQUIRE( new_alice_assets.get_hbd_balance().amount.value == ASSET( "2.500 TBD" ).amount.value );
    validate_database();
    ...
    BOOST_REQUIRE( new_bob_assets.get_balance().amount.value == ASSET( "3.000 TESTS" ).amount.value );
    BOOST_REQUIRE( new_bob_assets.get_hbd_balance().amount.value == ASSET( "4.000 TBD" ).amount.value );
...
BOOST_AUTO_TEST_CASE( limit_order_create_apply )
{
  try
  {
    ...
    BOOST_REQUIRE( bob_assets.get_balance().amount.value == ASSET( "0.000 TESTS" ).amount.value );
    BOOST_REQUIRE( bob_assets.get_hbd_balance().amount.value == ASSET( "1000.000 TBD" ).amount.value );
    validate_database();
    ...
    BOOST_REQUIRE( alice_assets.get_balance().amount.value == ASSET( "1000.000 TESTS" ).amount.value );
    BOOST_REQUIRE( alice_assets.get_hbd_balance().amount.value == ASSET( "0.000 TBD" ).amount.value );
    validate_database();
    ...
    BOOST_REQUIRE( alice_assets.get_balance().amount.value == ASSET( "990.000 TESTS" ).amount.value );
    BOOST_REQUIRE( alice_assets.get_hbd_balance().amount.value == ASSET( "0.000 TBD" ).amount.value );
    validate_database();
    ...
    BOOST_REQUIRE( limit_order_idx.find( boost::make_tuple( "bob", op.orderid ) ) == limit_order_idx.end() );
    BOOST_REQUIRE( alice_assets.get_balance().amount.value == ASSET( "990.000 TESTS" ).amount.value );
    BOOST_REQUIRE( alice_assets.get_hbd_balance().amount.value == ASSET( "7.500 TBD" ).amount.value );
    BOOST_REQUIRE( bob_assets.get_balance().amount.value == ASSET( "5.000 TESTS" ).amount.value );
    BOOST_REQUIRE( bob_assets.get_hbd_balance().amount.value == ASSET( "992.500 TBD" ).amount.value );
    ...
    BOOST_REQUIRE( alice_assets.get_balance().amount.value == ASSET( "990.000 TESTS" ).amount.value );
    BOOST_REQUIRE( alice_assets.get_hbd_balance().amount.value == ASSET( "15.000 TBD" ).amount.value );
    BOOST_REQUIRE( bob_assets.get_balance().amount.value == ASSET( "10.000 TESTS" ).amount.value );
    BOOST_REQUIRE( bob_assets.get_hbd_balance().amount.value == ASSET( "977.500 TBD" ).amount.value );
    validate_database();
    ...
    BOOST_REQUIRE( alice_assets.get_balance().amount.value == ASSET( "985.000 TESTS" ).amount.value );
    BOOST_REQUIRE( alice_assets.get_hbd_balance().amount.value == ASSET( "22.500 TBD" ).amount.value );
    BOOST_REQUIRE( bob_assets.get_balance().amount.value == ASSET( "15.000 TESTS" ).amount.value );
    BOOST_REQUIRE( bob_assets.get_hbd_balance().amount.value == ASSET( "977.500 TBD" ).amount.value );
    validate_database();
    ...
    BOOST_REQUIRE( limit_order->get_market() == std::make_pair( HBD_SYMBOL, HIVE_SYMBOL ) );
    BOOST_REQUIRE( alice_assets.get_balance().amount.value == ASSET( "975.000 TESTS" ).amount.value );
    BOOST_REQUIRE( alice_assets.get_hbd_balance().amount.value == ASSET( "33.500 TBD" ).amount.value );
    BOOST_REQUIRE( bob_assets.get_balance().amount.value == ASSET( "25.000 TESTS" ).amount.value );
    BOOST_REQUIRE( bob_assets.get_hbd_balance().amount.value == ASSET( "965.500 TBD" ).amount.value );
    validate_database();
    ...
    BOOST_REQUIRE( limit_order->get_market() == std::make_pair( HBD_SYMBOL, HIVE_SYMBOL ) );
    BOOST_REQUIRE( alice_assets.get_balance().amount.value == ASSET( "955.000 TESTS" ).amount.value );
    BOOST_REQUIRE( alice_assets.get_hbd_balance().amount.value == ASSET( "45.500 TBD" ).amount.value );
    BOOST_REQUIRE( bob_assets.get_balance().amount.value == ASSET( "35.909 TESTS" ).amount.value );
    BOOST_REQUIRE( bob_assets.get_hbd_balance().amount.value == ASSET( "954.500 TBD" ).amount.value );
    validate_database();
  }
  FC_LOG_AND_RETHROW()
}
...
BOOST_AUTO_TEST_CASE( escrow_transfer_apply )
{
  try
  {
    ...
    BOOST_REQUIRE( alice_assets.get_balance() == alice_hive_balance );
    BOOST_REQUIRE( alice_assets.get_hbd_balance() == alice_hbd_balance );
    BOOST_REQUIRE( bob_assets.get_balance() == bob_hive_balance );
    BOOST_REQUIRE( bob_assets.get_hbd_balance() == bob_hbd_balance );
    BOOST_REQUIRE( sam_assets.get_balance() == sam_hive_balance );
    BOOST_REQUIRE( sam_assets.get_hbd_balance() == sam_hbd_balance );
...
BOOST_AUTO_TEST_CASE( delegate_vesting_shares_apply )
{
  try
  {
    ...
    BOOST_REQUIRE( alice_assets.get_voting_manabar().current_mana == old_manabar.current_mana - op.vesting_shares.amount.value );
    BOOST_REQUIRE( alice_assets.get_downvote_manabar().current_mana == old_downvote_manabar.current_mana - op.vesting_shares.amount.value / 4 );
    BOOST_REQUIRE( GET_ASSETS( "bob" ).get_received_vesting() == ASSET( "10000000.000000 VESTS" ) );
    BOOST_REQUIRE( bob_assets.get_voting_manabar().current_mana == old_bob_manabar.current_mana + op.vesting_shares.amount.value );
    BOOST_REQUIRE( bob_assets.get_downvote_manabar().current_mana == old_bob_downvote_manabar.current_mana + op.vesting_shares.amount.value / 4 );
    ...
    BOOST_REQUIRE( alice_assets.get_voting_manabar().current_mana == old_manabar.current_mana - delta );
    BOOST_REQUIRE( alice_assets.get_downvote_manabar().current_mana == old_downvote_manabar.current_mana - delta / 4 );
    BOOST_REQUIRE( GET_ASSETS( "bob" ).get_received_vesting() == ASSET( "20000000.000000 VESTS"));
    BOOST_REQUIRE( bob_assets.get_voting_manabar().current_mana == old_bob_manabar.current_mana + delta );
    BOOST_REQUIRE( bob_assets.get_downvote_manabar().current_mana == old_bob_downvote_manabar.current_mana + delta / 4 );
    ...
    BOOST_REQUIRE( alice_comment_cashout->get_net_rshares() == old_manabar.current_mana - bob_assets.get_voting_manabar().current_mana - HIVE_VOTE_DUST_THRESHOLD );
    BOOST_REQUIRE( itr->get_rshares() == old_manabar.current_mana - bob_assets.get_voting_manabar().current_mana - HIVE_VOTE_DUST_THRESHOLD );
...
BOOST_AUTO_TEST_CASE( create_claimed_account_apply )
{
  try
  {
    ...
    BOOST_REQUIRE( bob_assets.get_vesting().amount.value == ASSET( "0.000000 VESTS" ).amount.value );
