...
BOOST_AUTO_TEST_CASE( update_outdel_overflow )
{
  try
  {
    ...
    BOOST_REQUIRE_EQUAL( alice_rc_before.get_rc_manabar().current_mana, creation_rc - ( 57285 + 57287 ) ); // cost of the two delegate rc ops (the one to dave costs more because more data is in the op)

    BOOST_REQUIRE_EQUAL( bob_rc_account_before.get_rc_manabar().current_mana, creation_rc + 10 );
    BOOST_REQUIRE_EQUAL( bob_rc_account_before.get_last_max_rc(), creation_rc + 10 );
    BOOST_REQUIRE_EQUAL( bob_rc_account_before.get_received_rc(), 10 );
    BOOST_REQUIRE_EQUAL( dave_rc_account_before.get_rc_manabar().current_mana, creation_rc + vesting_amount - 10 );
    BOOST_REQUIRE_EQUAL( dave_rc_account_before.get_last_max_rc(), creation_rc + vesting_amount - 10 );
    BOOST_REQUIRE_EQUAL( dave_rc_account_before.get_received_rc(), uint64_t(vesting_amount - 10) );
    ...
    BOOST_REQUIRE_EQUAL( alice_rc_after.get_last_max_rc(), creation_rc );
    BOOST_REQUIRE_EQUAL( alice_rc_after.get_rc_manabar().current_mana, creation_rc - 58044 );

    BOOST_REQUIRE_EQUAL( bob_rc_account_after.get_rc_manabar().current_mana, creation_rc + 5 );
    BOOST_REQUIRE_EQUAL( bob_rc_account_after.get_last_max_rc(), creation_rc + 5 );
    BOOST_REQUIRE_EQUAL( bob_rc_account_after.get_received_rc(), 5 );

    BOOST_REQUIRE_EQUAL( dave_rc_account_after.get_rc_manabar().current_mana, creation_rc + vesting_amount - 10 );
    BOOST_REQUIRE_EQUAL( dave_rc_account_after.get_last_max_rc(), creation_rc + vesting_amount - 10 );
    BOOST_REQUIRE_EQUAL( dave_rc_account_after.get_received_rc(), uint64_t(vesting_amount - 10) );
    ...
    BOOST_REQUIRE_EQUAL( alice_rc_after_two.get_delegated_rc(), uint64_t(vesting_amount) - 11 );
    BOOST_REQUIRE_EQUAL( alice_rc_after_two.get_received_rc(), 0 );
    BOOST_REQUIRE_EQUAL( alice_rc_after_two.get_last_max_rc(), creation_rc );
    BOOST_REQUIRE_EQUAL( alice_rc_after_two.get_rc_manabar().current_mana, creation_rc - ( 58044 + 58045 ) );

    BOOST_REQUIRE_EQUAL( bob_rc_account_after_two.get_rc_manabar().current_mana, creation_rc );
    BOOST_REQUIRE_EQUAL( bob_rc_account_after_two.get_last_max_rc(), creation_rc );
    BOOST_REQUIRE_EQUAL( bob_rc_account_after_two.get_received_rc(), 0 );

    BOOST_REQUIRE_EQUAL( dave_rc_account_after_two.get_rc_manabar().current_mana, creation_rc + vesting_amount - 11 );
    BOOST_REQUIRE_EQUAL( dave_rc_account_after_two.get_last_max_rc(), creation_rc + vesting_amount - 11 );
    BOOST_REQUIRE_EQUAL( dave_rc_account_after_two.get_received_rc(), uint64_t(vesting_amount - 11) );
...
BOOST_AUTO_TEST_CASE( update_outdel_overflow_many_accounts )
{
  try
  {
    ...
    BOOST_REQUIRE_EQUAL( actor0_rc_account_before.get_rc_manabar().current_mana, creation_rc + 10 );
    BOOST_REQUIRE_EQUAL( actor0_rc_account_before.get_last_max_rc(), creation_rc + 10 );
    BOOST_REQUIRE_EQUAL( actor0_rc_account_before.get_received_rc(), 10 );

    BOOST_REQUIRE_EQUAL( actor2_rc_account_before.get_rc_manabar().current_mana, creation_rc + 10 );
    BOOST_REQUIRE_EQUAL( actor2_rc_account_before.get_last_max_rc(), creation_rc + 10 );
    BOOST_REQUIRE_EQUAL( actor2_rc_account_before.get_received_rc(), 10 );
    ...
    BOOST_REQUIRE_EQUAL( actor0_rc_account_after.get_rc_manabar().current_mana, creation_rc );
    BOOST_REQUIRE_EQUAL( actor0_rc_account_after.get_last_max_rc(), creation_rc );
    BOOST_REQUIRE_EQUAL( actor0_rc_account_after.get_received_rc(), 0 );

    BOOST_REQUIRE_EQUAL( actor2_rc_account_after.get_rc_manabar().current_mana, creation_rc + 5 );
    BOOST_REQUIRE_EQUAL( actor2_rc_account_after.get_last_max_rc(), creation_rc + 5 );
    BOOST_REQUIRE_EQUAL( actor2_rc_account_after.get_received_rc(), 5 );
    ...
    BOOST_REQUIRE_EQUAL( alice_rc_end.get_last_max_rc(), creation_rc );
...
BOOST_AUTO_TEST_CASE( direct_rc_delegation_vesting_withdrawal )
{
  try
  {
...

    {
      ...
      BOOST_REQUIRE_EQUAL( alice_rc_account.get_last_max_rc(), creation_rc );

      // There wasn't enough to sustain the delegation to bob, so it got modified
      BOOST_REQUIRE_EQUAL( bob_rc_account.get_rc_manabar().current_mana, delegated_rc + creation_rc - withdraw_rate.amount.value );
      BOOST_REQUIRE_EQUAL( bob_rc_account.get_received_rc(), uint64_t(delegated_rc - withdraw_rate.amount.value) );
      BOOST_REQUIRE_EQUAL( bob_rc_account.get_last_max_rc(), delegated_rc - withdraw_rate.amount.value + creation_rc );

      BOOST_REQUIRE_EQUAL( dave_rc_account.get_rc_manabar().current_mana, creation_rc + delegated_rc );
      BOOST_REQUIRE_EQUAL( dave_rc_account.get_last_max_rc(), creation_rc + delegated_rc );
      BOOST_REQUIRE_EQUAL( dave_rc_account.get_received_rc(), uint64_t(delegated_rc) );
    ...
    for( int i = 1; i < HIVE_VESTING_WITHDRAW_INTERVALS - 1; i++ )
    {
      ...
      BOOST_REQUIRE_EQUAL( alice_rc_account.get_delegated_rc(), uint64_t(vesting_shares - total_vests_withdrew) ); // total amount minus what was withdrew
      BOOST_REQUIRE_EQUAL( alice_rc_account.get_rc_manabar().current_mana, creation_rc );
      BOOST_REQUIRE_EQUAL( alice_rc_account.get_received_rc(), 0 );
      BOOST_REQUIRE_EQUAL( alice_rc_account.get_last_max_rc(), creation_rc );

      if (total_vests_withdrew < delegated_rc) {
        // Only the first delegation is affected
        BOOST_REQUIRE_EQUAL( bob_rc_account.get_rc_manabar().current_mana, delegated_rc + creation_rc - total_vests_withdrew );
        BOOST_REQUIRE_EQUAL( bob_rc_account.get_received_rc(), uint64_t(delegated_rc - total_vests_withdrew) );
        BOOST_REQUIRE_EQUAL( bob_rc_account.get_last_max_rc(), delegated_rc + creation_rc - total_vests_withdrew );

        BOOST_REQUIRE_EQUAL( dave_rc_account.get_rc_manabar().current_mana, delegated_rc + creation_rc );
        BOOST_REQUIRE_EQUAL( dave_rc_account.get_last_max_rc(), delegated_rc + creation_rc );
        BOOST_REQUIRE_EQUAL( dave_rc_account.get_received_rc(), uint64_t(delegated_rc) );

        BOOST_REQUIRE_EQUAL( delegation_bob->from, alice_id );
        BOOST_REQUIRE_EQUAL( delegation_bob->to, bob_id );
        BOOST_REQUIRE_EQUAL( delegation_bob->delegated_rc, uint64_t(delegated_rc - total_vests_withdrew) );
        ...
        BOOST_REQUIRE_EQUAL( bob_rc_account.get_rc_manabar().current_mana, creation_rc );
        BOOST_REQUIRE_EQUAL( bob_rc_account.get_received_rc(), 0 );
        BOOST_REQUIRE_EQUAL( bob_rc_account.get_last_max_rc(), creation_rc );
        BOOST_REQUIRE_EQUAL( dave_rc_account.get_rc_manabar().current_mana, creation_rc + delegated_rc - (total_vests_withdrew - delegated_rc) );
        BOOST_REQUIRE_EQUAL( dave_rc_account.get_received_rc(), uint64_t(delegated_rc - (total_vests_withdrew - delegated_rc)) );
        BOOST_REQUIRE_EQUAL( dave_rc_account.get_last_max_rc(), creation_rc + delegated_rc - (total_vests_withdrew - delegated_rc) );
...

    {
      ...
      BOOST_REQUIRE_EQUAL( dave_rc_account.get_rc_manabar().current_mana, creation_rc );
      BOOST_REQUIRE_EQUAL( dave_rc_account.get_last_max_rc(), creation_rc );
      BOOST_REQUIRE_EQUAL( dave_rc_account.get_received_rc(), 0 );
...
BOOST_AUTO_TEST_CASE( direct_rc_delegation_vesting_withdrawal_routes )
{
  try
  {
...

    {
      ...
      BOOST_REQUIRE_EQUAL( alice_rc_account.get_received_rc(), 0 );
      BOOST_REQUIRE_EQUAL( alice_rc_account.get_rc_manabar().current_mana, creation_rc ); //  withdraw_rate.amount.value is withdrew, but half is auto vested back
      BOOST_REQUIRE_EQUAL( alice_rc_account.get_last_max_rc(), creation_rc );
      ...
      BOOST_REQUIRE_EQUAL( bob_rc_account.get_rc_manabar().current_mana, delegated_rc + creation_rc - withdraw_rate.amount.value * 1.5 + withdraw_rate.amount.value / 4 );
      BOOST_REQUIRE_EQUAL( bob_rc_account.get_received_rc(), uint64_t(delegated_rc - withdraw_rate.amount.value * 1.5) );
      BOOST_REQUIRE_EQUAL( bob_rc_account.get_last_max_rc(), delegated_rc + creation_rc - withdraw_rate.amount.value * 1.5  + withdraw_rate.amount.value / 4 );
...
BOOST_AUTO_TEST_CASE( rc_delegation_removal_no_rc )
{
  try
  {
    ...
    BOOST_REQUIRE_EQUAL( bob_rc_account.get_rc_manabar().current_mana, 0 );
    BOOST_REQUIRE_GE( bob_account.get_maximum_rc( bob_rc_account, bob_assets, bob_time ), 0 );
...
BOOST_AUTO_TEST_CASE( rc_negative_regeneration_bug )
{
  try
  {
    ...
    db->rc().regenerate_rc_mana( db->get_account( "pattern2" ), db->head_block_time() );
    BOOST_REQUIRE_EQUAL( delegatee_rc.get_rc_manabar().current_mana, pattern2_rc.get_rc_manabar().current_mana - undelegated );
...
BOOST_AUTO_TEST_CASE( update_outdel_overflow_delegatee )
{
  try
  {
    ...
    BOOST_REQUIRE_EQUAL( bob_rc_account_before.get_delegated_rc(), uint64_t(vesting_amount) );
    BOOST_REQUIRE_EQUAL( bob_rc_account_before.get_last_max_rc(), creation_rc );
    BOOST_REQUIRE_EQUAL( bob_rc_account_before.get_received_rc(), 0 );
    BOOST_REQUIRE_EQUAL( bob_rc_account_before.get_rc_manabar().current_mana, creation_rc - ( 57284 + 57286 ) ); // cost of the two delegate rc ops (the one to dave costs more because more data is in the op)

    BOOST_REQUIRE_EQUAL( eve_rc_account_before.get_rc_manabar().current_mana, creation_rc + vesting_amount - 10 );
    BOOST_REQUIRE_EQUAL( eve_rc_account_before.get_last_max_rc(), creation_rc + vesting_amount - 10 );
    BOOST_REQUIRE_EQUAL( eve_rc_account_before.get_received_rc(), uint64_t(vesting_amount - 10) );

    BOOST_REQUIRE_EQUAL( dave_rc_account_before.get_rc_manabar().current_mana, creation_rc + 10 );
    BOOST_REQUIRE_EQUAL( dave_rc_account_before.get_last_max_rc(), creation_rc + 10 );
    BOOST_REQUIRE_EQUAL( dave_rc_account_before.get_received_rc(), 10 );
    ...
    BOOST_REQUIRE_EQUAL( alice_rc_after.get_received_rc(), 0 );
    BOOST_REQUIRE_EQUAL( alice_rc_after.get_last_max_rc(), creation_rc ); // Still creation_rc because the vesting delegation didn't come back

    BOOST_REQUIRE_EQUAL( bob_rc_account_after.get_delegated_rc(), 0 );
    BOOST_REQUIRE_EQUAL( bob_rc_account_after.get_last_max_rc(), creation_rc );
    BOOST_REQUIRE_EQUAL( bob_rc_account_after.get_received_rc(), 0 );

    BOOST_REQUIRE_EQUAL( eve_rc_account_after.get_rc_manabar().current_mana, creation_rc );
    BOOST_REQUIRE_EQUAL( eve_rc_account_after.get_last_max_rc(), creation_rc );
    BOOST_REQUIRE_EQUAL( eve_rc_account_after.get_received_rc(), 0 );

    BOOST_REQUIRE_EQUAL( dave_rc_account_after.get_rc_manabar().current_mana, creation_rc );
    BOOST_REQUIRE_EQUAL( dave_rc_account_after.get_last_max_rc(), creation_rc );
    BOOST_REQUIRE_EQUAL( dave_rc_account_after.get_received_rc(), 0 );
...
BOOST_AUTO_TEST_CASE( update_outdel_overflow_delegatee_performance )
{
  try
  {
    ...
    for( auto& account : accounts )
    {
      ...
      BOOST_REQUIRE_EQUAL( _mrc.get_received_rc(), 10 );
    }
    ...
    for( auto& account : accounts )
    {
      const auto& _account = db->get_account( account.account );
      const auto& _mrc = db->get< manabars_rc_object >( manabars_rc_object::id_type( _account.get_id().get_value() ) );
      BOOST_REQUIRE_EQUAL( _mrc.get_received_rc(), ( i >= removal_limit ? 10 : 0 ) );
      ++i;
    }
    generate_block();
    ...
    for( auto& account : accounts )
    {
      const auto& _account = db->get_account( account.account );
      const auto& _mrc = db->get< manabars_rc_object >( manabars_rc_object::id_type( _account.get_id().get_value() ) );
      BOOST_REQUIRE_EQUAL( _mrc.get_received_rc(), ( i >= removal_limit * 2 ? 10 : i >= removal_limit ? 5 : 0 ) );
      ++i;
    }
