...
{
  return beekeeper_wallet_manager( std::make_shared<session_manager>( "127.0.0.1:666" ), std::make_shared<beekeeper_instance>( appbase::app(), cmd_wallet_dir, "127.0.0.1:666" ),
