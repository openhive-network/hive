...
BOOST_AUTO_TEST_CASE( delayed_voting_proxy_02 )
{
  try
  {
    ...
    {
      const auto& dq = db->get_account( account_name ).get_delayed_votes();
...
{
  auto vcmp = []( const std::vector< delayed_votes_data >& a, const account_details::t_delayed_votes& b )
  {
  ...
  */
  ...
  }
  {
    ...
    const auto& alice2 = db->get_account( "alice" );
    ...
    const auto& bob2 = db->get_account( "bob" );
