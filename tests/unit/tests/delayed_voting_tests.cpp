...
#define GET_DV( name ) db->get< delayed_votes_object, by_account_id >( db->get_account( name ).get_id() )
#define GET_ASSETS( name ) db->get< assets_object, by_account_id >( db->get_account( name ).get_id() )
