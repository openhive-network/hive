...
`transaction_object::packed_trx`, `comment_cashout_object::permlink`, and
...
Examples may be seen with fields `transaction_object::packed_trx`, `comment_cashout_object::permlink`, and
`feed_history_object::price_history`.
